...
PROTOBUF_NAMESPACE_OPEN
template<> TF_API_NO_C ::tensorflow::TensorProto* Arena::CreateMaybeMessage<::tensorflow::TensorProto>(Arena*);
template<> TF_API_NO_C ::tensorflow::VariantTensorDataProto* Arena::CreateMaybeMessage<::tensorflow::VariantTensorDataProto>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace tensorflow {

// ===================================================================

class TF_CLASS TensorProto :
...
class TF_CLASS VariantTensorDataProto :
