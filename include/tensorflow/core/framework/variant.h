...
class Variant {
 public:
  ...
  static const /*constexpr*/ bool CanInlineType() {
 ...
 private:
  ...
  static const /*constexpr*/ int kMaxInlineValueAlignSize = alignof(Value<void*>);
  ...
  struct InlineValue {
    ...
    static const /*constexpr*/ int kMaxValueSize = (64 - /*some extra padding=*/16);
