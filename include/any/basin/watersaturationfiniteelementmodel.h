 ...
 */
#ifndef __ANYBASIN_HYPER_WATER_SATURATION_FINITE_ELEMENT_MODEL_H__
#define __ANYBASIN_HYPER_WATER_SATURATION_FINITE_ELEMENT_MODEL_H__
...
namespace AnyBasin
{
	...
	*
	**/
	class CWaterSaturationFiniteElementModel : public CHyperFiniteElementModel
	{
	public:
		//
		enum SaturationType
	...
	public:
		CWaterSaturationFiniteElementModel(CAnyHyperBasinSimulator *simulator, short staturation_type);
		~CWaterSaturationFiniteElementModel();
