...
static const /*constexpr*/ DataType STATE_ELEMENT_DTYPE = DT_INT64;

using Algorithm = StateElementType;
static const /*constexpr*/ DataType ALGORITHM_DTYPE = STATE_ELEMENT_DTYPE;
static const /*constexpr*/ Algorithm RNG_ALG_PHILOX = 1;
static const /*constexpr*/ Algorithm RNG_ALG_THREEFRY = 2;

using random::PhiloxRandom;

static const /*constexpr*/ int64 PHILOX_MIN_STATE_SIZE =
    (PhiloxRandom::ResultType::kElementCount +
     PhiloxRandom::Key::kElementCount) /
    2;
static const /*constexpr*/ int64 THREEFRY_MIN_STATE_SIZE = 2;
