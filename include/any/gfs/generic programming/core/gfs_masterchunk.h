 ...
 */
#ifndef ANYWAY_RCF_CORE_RCF_GFS_CHUNK_HANDLE_H
#define ANYWAY_RCF_CORE_RCF_GFS_CHUNK_HANDLE_H
...
namespace anyway
{
	namespace rcf
	{
		...
		**/
		...
		struct gfs_masterchunk
		{
			typedef typename traits::gfs_masterchunk
				<
