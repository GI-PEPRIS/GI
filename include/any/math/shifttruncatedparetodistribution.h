 ...
 */
#ifndef __ANYMATH_SHIFT_TRUNCATED_PARETO_DISTRIBUTION_H__
#define __ANYMATH_SHIFT_TRUNCATED_PARETO_DISTRIBUTION_H__
...
namespace AnyMath
{
	...
	* TSP
	**/
	class CShiftTruncatedParetoDistribution : public CAnyDistributionStrategy
	{
	public:
		//
		//
		...
		*
		**/
		CShiftTruncatedParetoDistribution();
