...
// source: tensor_forest_params.proto

#ifndef GOOGLE_PROTOBUF_INCLUDED_tensor_5fforest_5fparams_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_tensor_5fforest_5fparams_2eproto
...
#include "protobuf/port_def.inc"
#define PROTOBUF_INTERNAL_EXPORT_tensor_5fforest_5fparams_2eproto
...
struct TableStruct_tensor_5fforest_5fparams_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_tensor_5fforest_5fparams_2eproto;
...
enum LeafModelType : int {
  MODEL_DENSE_CLASSIFICATION = 0,
  MODEL_SPARSE_CLASSIFICATION = 1,
  MODEL_REGRESSION = 2,
  MODEL_SPARSE_OR_DENSE_CLASSIFICATION = 3,
  LeafModelType_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::min(),
  LeafModelType_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::max()
};
bool LeafModelType_IsValid(int value);
constexpr LeafModelType LeafModelType_MIN = MODEL_DENSE_CLASSIFICATION;
constexpr LeafModelType LeafModelType_MAX = MODEL_SPARSE_OR_DENSE_CLASSIFICATION;
constexpr int LeafModelType_ARRAYSIZE = LeafModelType_MAX + 1;

const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* LeafModelType_descriptor();
template<typename T>
inline const std::string& LeafModelType_Name(T enum_t_value) {
  static_assert(::std::is_same<T, LeafModelType>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function LeafModelType_Name.");
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    LeafModelType_descriptor(), enum_t_value);
}
inline bool LeafModelType_Parse(
    const std::string& name, LeafModelType* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<LeafModelType>(
    LeafModelType_descriptor(), name, value);
}
enum StatsModelType : int {
  STATS_DENSE_GINI = 0,
  STATS_SPARSE_GINI = 1,
  STATS_LEAST_SQUARES_REGRESSION = 2,
  STATS_SPARSE_THEN_DENSE_GINI = 3,
  STATS_FIXED_SIZE_SPARSE_GINI = 4,
  StatsModelType_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::min(),
  StatsModelType_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::max()
};
bool StatsModelType_IsValid(int value);
constexpr StatsModelType StatsModelType_MIN = STATS_DENSE_GINI;
constexpr StatsModelType StatsModelType_MAX = STATS_FIXED_SIZE_SPARSE_GINI;
constexpr int StatsModelType_ARRAYSIZE = StatsModelType_MAX + 1;

const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* StatsModelType_descriptor();
template<typename T>
inline const std::string& StatsModelType_Name(T enum_t_value) {
  static_assert(::std::is_same<T, StatsModelType>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function StatsModelType_Name.");
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    StatsModelType_descriptor(), enum_t_value);
}
inline bool StatsModelType_Parse(
    const std::string& name, StatsModelType* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<StatsModelType>(
    StatsModelType_descriptor(), name, value);
}
enum SplitCollectionType : int {
  COLLECTION_BASIC = 0,
  GRAPH_RUNNER_COLLECTION = 1,
  SplitCollectionType_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::min(),
  SplitCollectionType_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::max()
};
bool SplitCollectionType_IsValid(int value);
constexpr SplitCollectionType SplitCollectionType_MIN = COLLECTION_BASIC;
constexpr SplitCollectionType SplitCollectionType_MAX = GRAPH_RUNNER_COLLECTION;
constexpr int SplitCollectionType_ARRAYSIZE = SplitCollectionType_MAX + 1;

const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* SplitCollectionType_descriptor();
template<typename T>
inline const std::string& SplitCollectionType_Name(T enum_t_value) {
  static_assert(::std::is_same<T, SplitCollectionType>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function SplitCollectionType_Name.");
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    SplitCollectionType_descriptor(), enum_t_value);
}
inline bool SplitCollectionType_Parse(
    const std::string& name, SplitCollectionType* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<SplitCollectionType>(
    SplitCollectionType_descriptor(), name, value);
}
enum SplitPruningStrategyType : int {
  SPLIT_PRUNE_NONE = 0,
  SPLIT_PRUNE_HALF = 1,
  SPLIT_PRUNE_QUARTER = 2,
  SPLIT_PRUNE_10_PERCENT = 3,
  SPLIT_PRUNE_HOEFFDING = 4,
  SplitPruningStrategyType_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::min(),
  SplitPruningStrategyType_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::max()
};
bool SplitPruningStrategyType_IsValid(int value);
constexpr SplitPruningStrategyType SplitPruningStrategyType_MIN = SPLIT_PRUNE_NONE;
constexpr SplitPruningStrategyType SplitPruningStrategyType_MAX = SPLIT_PRUNE_HOEFFDING;
constexpr int SplitPruningStrategyType_ARRAYSIZE = SplitPruningStrategyType_MAX + 1;

const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* SplitPruningStrategyType_descriptor();
template<typename T>
inline const std::string& SplitPruningStrategyType_Name(T enum_t_value) {
  static_assert(::std::is_same<T, SplitPruningStrategyType>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function SplitPruningStrategyType_Name.");
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    SplitPruningStrategyType_descriptor(), enum_t_value);
}
inline bool SplitPruningStrategyType_Parse(
    const std::string& name, SplitPruningStrategyType* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<SplitPruningStrategyType>(
    SplitPruningStrategyType_descriptor(), name, value);
}
enum SplitFinishStrategyType : int {
  SPLIT_FINISH_BASIC = 0,
  SPLIT_FINISH_DOMINATE_HOEFFDING = 2,
  SPLIT_FINISH_DOMINATE_BOOTSTRAP = 3,
  SplitFinishStrategyType_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::min(),
  SplitFinishStrategyType_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::max()
};
bool SplitFinishStrategyType_IsValid(int value);
constexpr SplitFinishStrategyType SplitFinishStrategyType_MIN = SPLIT_FINISH_BASIC;
constexpr SplitFinishStrategyType SplitFinishStrategyType_MAX = SPLIT_FINISH_DOMINATE_BOOTSTRAP;
constexpr int SplitFinishStrategyType_ARRAYSIZE = SplitFinishStrategyType_MAX + 1;

const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* SplitFinishStrategyType_descriptor();
template<typename T>
inline const std::string& SplitFinishStrategyType_Name(T enum_t_value) {
  static_assert(::std::is_same<T, SplitFinishStrategyType>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function SplitFinishStrategyType_Name.");
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    SplitFinishStrategyType_descriptor(), enum_t_value);
}
inline bool SplitFinishStrategyType_Parse(
    const std::string& name, SplitFinishStrategyType* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<SplitFinishStrategyType>(
    SplitFinishStrategyType_descriptor(), name, value);
}
// ===================================================================

class SplitPruningConfig :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:tensorflow.tensorforest.SplitPruningConfig) */ {
 public:
  SplitPruningConfig();
  ...
  inline void Swap(SplitPruningConfig* other) {
  ...
  inline SplitPruningConfig* New() const final {
    return CreateMaybeMessage<SplitPruningConfig>(nullptr);
  }

  SplitPruningConfig* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "tensorflow.tensorforest.SplitPruningConfig";
  }
  private:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_tensor_5fforest_5fparams_2eproto);
    return ::descriptor_table_tensor_5fforest_5fparams_2eproto.file_level_metadata[kIndexInFileMessages];
  }
  ...
  enum : int {
    kPruneEverySamplesFieldNumber = 1,
    kTypeFieldNumber = 2,
  };
 ...
 private:
  ...
  friend struct ::TableStruct_tensor_5fforest_5fparams_2eproto;
};
// -------------------------------------------------------------------

class SplitFinishConfig :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:tensorflow.tensorforest.SplitFinishConfig) */ {
 public:
  SplitFinishConfig();
  ...
  inline void Swap(SplitFinishConfig* other) {
    if (other == this) return;
    InternalSwap(other);
  }
  ...
  inline SplitFinishConfig* New() const final {
    return CreateMaybeMessage<SplitFinishConfig>(nullptr);
  }

  SplitFinishConfig* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "tensorflow.tensorforest.SplitFinishConfig";
  }
  private:
  inline ::PROTOBUF_NAMESPACE_ID::Arena* GetArenaNoVirtual() const {
    return nullptr;
...
class LinearParam :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:tensorflow.tensorforest.LinearParam) */ {
 public:
  LinearParam();
  virtual ~LinearParam();
  ...
  inline void Swap(LinearParam* other) {
    if (other == this) return;
    InternalSwap(other);
  }
  ...
  inline LinearParam* New() const final {
    return CreateMaybeMessage<LinearParam>(nullptr);
  }

  LinearParam* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "tensorflow.tensorforest.LinearParam";
  }
  private:
  inline ::PROTOBUF_NAMESPACE_ID::Arena* GetArenaNoVirtual() const {
    return nullptr;
  ...
  enum : int {
    kSlopeFieldNumber = 1,
    kYInterceptFieldNumber = 2,
    kMinValFieldNumber = 3,
    kMaxValFieldNumber = 4,
  };
  // float slope = 1;
  void clear_slope();
  float slope() const;
...
class ExponentialParam :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:tensorflow.tensorforest.ExponentialParam) */ {
 public:
  ExponentialParam();
  ...
  inline void Swap(ExponentialParam* other) {
    if (other == this) return;
    InternalSwap(other);
  }
  ...
  inline ExponentialParam* New() const final {
    return CreateMaybeMessage<ExponentialParam>(nullptr);
  }

  ExponentialParam* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "tensorflow.tensorforest.ExponentialParam";
  }
  private:
  inline ::PROTOBUF_NAMESPACE_ID::Arena* GetArenaNoVirtual() const {
    return nullptr;
...
class ThresholdParam :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:tensorflow.tensorforest.ThresholdParam) */ {
 public:
  ThresholdParam();
  ...
  inline ThresholdParam* New() const final {
    return CreateMaybeMessage<ThresholdParam>(nullptr);
  }

  ThresholdParam* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "tensorflow.tensorforest.ThresholdParam";
  }
  private:
  inline ::PROTOBUF_NAMESPACE_ID::Arena* GetArenaNoVirtual() const {
    return nullptr;
  ...
  enum : int {
    kOnValueFieldNumber = 1,
    kOffValueFieldNumber = 2,
...
class DepthDependentParam :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:tensorflow.tensorforest.DepthDependentParam) */ {
 public:
  DepthDependentParam();
  ...
  inline void Swap(DepthDependentParam* other) {
    if (other == this) return;
    InternalSwap(other);
  }
  ...
  inline DepthDependentParam* New() const final {
    return CreateMaybeMessage<DepthDependentParam>(nullptr);
  }

  DepthDependentParam* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "tensorflow.tensorforest.DepthDependentParam";
  }
  private:
  inline ::PROTOBUF_NAMESPACE_ID::Arena* GetArenaNoVirtual() const {
    return nullptr;
  ...
  enum : int {
    kConstantValueFieldNumber = 1,
    kLinearFieldNumber = 2,
    kExponentialFieldNumber = 3,
...
class TensorForestParams :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:tensorflow.tensorforest.TensorForestParams) */ {
 public:
  TensorForestParams();
  ...
  inline void Swap(TensorForestParams* other) {
    if (other == this) return;
    InternalSwap(other);
  }
  ...
  inline TensorForestParams* New() const final {
    return CreateMaybeMessage<TensorForestParams>(nullptr);
  }

  TensorForestParams* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "tensorflow.tensorforest.TensorForestParams";
  }
  private:
  inline ::PROTOBUF_NAMESPACE_ID::Arena* GetArenaNoVirtual() const {
    return nullptr;
  ...
  enum : int {
    kGraphDirFieldNumber = 16,
    kPruningTypeFieldNumber = 4,
    kFinishTypeFieldNumber = 5,
    kNumSplitsToConsiderFieldNumber = 13,
    kSplitAfterSamplesFieldNumber = 14,
    kDominateFractionFieldNumber = 15,
    kMinSplitSamplesFieldNumber = 18,
    kLeafTypeFieldNumber = 1,
    kStatsTypeFieldNumber = 2,
    kCollectionTypeFieldNumber = 3,
    kNumTreesFieldNumber = 6,
    kMaxNodesFieldNumber = 7,
    kIsRegressionFieldNumber = 8,
    kDropFinalClassFieldNumber = 9,
    kCollateExamplesFieldNumber = 10,
    kCheckpointStatsFieldNumber = 11,
    kNumOutputsFieldNumber = 12,
    kNumSelectFeaturesFieldNumber = 17,
    kInequalityTestTypeFieldNumber = 19,
    kNumFeaturesFieldNumber = 21,
    kUseRunningStatsMethodFieldNumber = 20,
    kInitializeAverageSplitsFieldNumber = 22,
    kInferenceTreePathsFieldNumber = 23,
    kNumClassesToTrackFieldNumber = 24,
  };
  // string graph_dir = 16;
  ...
  ::PROTOBUF_NAMESPACE_ID::int32 num_trees() const;
  void set_num_trees(::PROTOBUF_NAMESPACE_ID::int32 value);

  // int32 max_nodes = 7;
  void clear_max_nodes();
  ::PROTOBUF_NAMESPACE_ID::int32 max_nodes() const;
  void set_max_nodes(::PROTOBUF_NAMESPACE_ID::int32 value);
  ...
  ::PROTOBUF_NAMESPACE_ID::int32 num_select_features() const;
  void set_num_select_features(::PROTOBUF_NAMESPACE_ID::int32 value);
  ...
  ::PROTOBUF_NAMESPACE_ID::int32 num_classes_to_track() const;
  void set_num_classes_to_track(::PROTOBUF_NAMESPACE_ID::int32 value);
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::InternalMetadataWithArena _internal_metadata_;
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr graph_dir_;
  ...
  ::PROTOBUF_NAMESPACE_ID::int32 num_trees_;
  ::PROTOBUF_NAMESPACE_ID::int32 max_nodes_;
  bool is_regression_;
  bool drop_final_class_;
  bool collate_examples_;
  bool checkpoint_stats_;
  ::PROTOBUF_NAMESPACE_ID::int32 num_outputs_;
  ::PROTOBUF_NAMESPACE_ID::int32 num_select_features_;
  ...
  ::PROTOBUF_NAMESPACE_ID::int32 num_classes_to_track_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_tensor_5fforest_5fparams_2eproto;
};
// ===================================================================
...
inline bool SplitPruningConfig::has_prune_every_samples() const {
  return this != internal_default_instance() && prune_every_samples_ != nullptr;
}
inline void SplitPruningConfig::clear_prune_every_samples() {
  if (GetArenaNoVirtual() == nullptr && prune_every_samples_ != nullptr) {
    delete prune_every_samples_;
  }
  prune_every_samples_ = nullptr;
}
inline const ::tensorflow::tensorforest::DepthDependentParam& SplitPruningConfig::prune_every_samples() const {
  ...
  return p != nullptr ? *p : *reinterpret_cast<const ::tensorflow::tensorforest::DepthDependentParam*>(
...
inline ::tensorflow::tensorforest::DepthDependentParam* SplitPruningConfig::mutable_prune_every_samples() {
  ...
  if (prune_every_samples_ == nullptr) {
...
inline void SplitPruningConfig::set_allocated_prune_every_samples(::tensorflow::tensorforest::DepthDependentParam* prune_every_samples) {
  ...
  if (prune_every_samples) {
    ...
    if (message_arena != submessage_arena) {
      prune_every_samples = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
...
inline bool SplitFinishConfig::has_check_every_steps() const {
  return this != internal_default_instance() && check_every_steps_ != nullptr;
}
inline void SplitFinishConfig::clear_check_every_steps() {
  if (GetArenaNoVirtual() == nullptr && check_every_steps_ != nullptr) {
    delete check_every_steps_;
  }
  check_every_steps_ = nullptr;
}
...
inline void SplitFinishConfig::set_allocated_check_every_steps(::tensorflow::tensorforest::DepthDependentParam* check_every_steps) {
  ...
  if (check_every_steps) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena = nullptr;
    if (message_arena != submessage_arena) {
      check_every_steps = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
...
inline ::tensorflow::tensorforest::ExponentialParam* DepthDependentParam::release_exponential() {
  ...
  if (has_exponential()) {
    ...
    ParamType_.exponential_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
...
inline bool TensorForestParams::has_pruning_type() const {
  return this != internal_default_instance() && pruning_type_ != nullptr;
}
inline void TensorForestParams::clear_pruning_type() {
  if (GetArenaNoVirtual() == nullptr && pruning_type_ != nullptr) {
    delete pruning_type_;
  }
  pruning_type_ = nullptr;
}
inline const ::tensorflow::tensorforest::SplitPruningConfig& TensorForestParams::pruning_type() const {
  ...
  return p != nullptr ? *p : *reinterpret_cast<const ::tensorflow::tensorforest::SplitPruningConfig*>(
...
inline void TensorForestParams::set_allocated_pruning_type(::tensorflow::tensorforest::SplitPruningConfig* pruning_type) {
  ...
  if (pruning_type) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena = nullptr;
    if (message_arena != submessage_arena) {
      pruning_type = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
...
inline bool TensorForestParams::has_finish_type() const {
  return this != internal_default_instance() && finish_type_ != nullptr;
}
inline void TensorForestParams::clear_finish_type() {
  if (GetArenaNoVirtual() == nullptr && finish_type_ != nullptr) {
    delete finish_type_;
  }
  finish_type_ = nullptr;
}
inline const ::tensorflow::tensorforest::SplitFinishConfig& TensorForestParams::finish_type() const {
  ...
  return p != nullptr ? *p : *reinterpret_cast<const ::tensorflow::tensorforest::SplitFinishConfig*>(
...
inline void TensorForestParams::set_allocated_finish_type(::tensorflow::tensorforest::SplitFinishConfig* finish_type) {
  ...
  if (finish_type) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena = nullptr;
    if (message_arena != submessage_arena) {
      finish_type = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
...
inline ::PROTOBUF_NAMESPACE_ID::int32 TensorForestParams::num_trees() const {
  // @@protoc_insertion_point(field_get:tensorflow.tensorforest.TensorForestParams.num_trees)
  return num_trees_;
}
inline void TensorForestParams::set_num_trees(::PROTOBUF_NAMESPACE_ID::int32 value) {
...
inline ::PROTOBUF_NAMESPACE_ID::int32 TensorForestParams::max_nodes() const {
  // @@protoc_insertion_point(field_get:tensorflow.tensorforest.TensorForestParams.max_nodes)
  return max_nodes_;
}
inline void TensorForestParams::set_max_nodes(::PROTOBUF_NAMESPACE_ID::int32 value) {
...
inline ::PROTOBUF_NAMESPACE_ID::int32 TensorForestParams::num_features() const {
  // @@protoc_insertion_point(field_get:tensorflow.tensorforest.TensorForestParams.num_features)
  return num_features_;
}
inline void TensorForestParams::set_num_features(::PROTOBUF_NAMESPACE_ID::int32 value) {
...
inline ::PROTOBUF_NAMESPACE_ID::int32 TensorForestParams::num_outputs() const {
  // @@protoc_insertion_point(field_get:tensorflow.tensorforest.TensorForestParams.num_outputs)
  return num_outputs_;
}
inline void TensorForestParams::set_num_outputs(::PROTOBUF_NAMESPACE_ID::int32 value) {
...
inline bool TensorForestParams::has_num_splits_to_consider() const {
  return this != internal_default_instance() && num_splits_to_consider_ != nullptr;
}
inline void TensorForestParams::clear_num_splits_to_consider() {
  if (GetArenaNoVirtual() == nullptr && num_splits_to_consider_ != nullptr) {
    delete num_splits_to_consider_;
  }
  num_splits_to_consider_ = nullptr;
}
...
inline ::tensorflow::tensorforest::DepthDependentParam* TensorForestParams::mutable_num_splits_to_consider() {
  ...
  if (num_splits_to_consider_ == nullptr) {
    auto* p = CreateMaybeMessage<::tensorflow::tensorforest::DepthDependentParam>(GetArenaNoVirtual());
...
inline void TensorForestParams::set_allocated_num_splits_to_consider(::tensorflow::tensorforest::DepthDependentParam* num_splits_to_consider) {
  ...
  if (num_splits_to_consider) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena = nullptr;
    if (message_arena != submessage_arena) {
      num_splits_to_consider = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
...
inline bool TensorForestParams::has_split_after_samples() const {
  return this != internal_default_instance() && split_after_samples_ != nullptr;
}
inline void TensorForestParams::clear_split_after_samples() {
  if (GetArenaNoVirtual() == nullptr && split_after_samples_ != nullptr) {
    delete split_after_samples_;
  }
  split_after_samples_ = nullptr;
}
...
inline ::tensorflow::tensorforest::DepthDependentParam* TensorForestParams::mutable_split_after_samples() {
  ...
  if (split_after_samples_ == nullptr) {
    auto* p = CreateMaybeMessage<::tensorflow::tensorforest::DepthDependentParam>(GetArenaNoVirtual());
...
inline void TensorForestParams::set_allocated_split_after_samples(::tensorflow::tensorforest::DepthDependentParam* split_after_samples) {
  ...
  if (split_after_samples) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena = nullptr;
    if (message_arena != submessage_arena) {
      split_after_samples = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
...
inline bool TensorForestParams::has_dominate_fraction() const {
  return this != internal_default_instance() && dominate_fraction_ != nullptr;
}
inline void TensorForestParams::clear_dominate_fraction() {
  if (GetArenaNoVirtual() == nullptr && dominate_fraction_ != nullptr) {
    delete dominate_fraction_;
  }
  dominate_fraction_ = nullptr;
}
...
inline void TensorForestParams::set_allocated_dominate_fraction(::tensorflow::tensorforest::DepthDependentParam* dominate_fraction) {
  ...
  if (dominate_fraction) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena = nullptr;
    if (message_arena != submessage_arena) {
      dominate_fraction = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
...
inline bool TensorForestParams::has_min_split_samples() const {
  return this != internal_default_instance() && min_split_samples_ != nullptr;
}
inline void TensorForestParams::clear_min_split_samples() {
  if (GetArenaNoVirtual() == nullptr && min_split_samples_ != nullptr) {
    delete min_split_samples_;
  }
  min_split_samples_ = nullptr;
}
...
inline void TensorForestParams::set_allocated_min_split_samples(::tensorflow::tensorforest::DepthDependentParam* min_split_samples) {
  ...
  if (min_split_samples) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena = nullptr;
    if (message_arena != submessage_arena) {
      min_split_samples = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
...
inline void TensorForestParams::clear_graph_dir() {
  graph_dir_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
...
inline void TensorForestParams::set_graph_dir(const std::string& value) {
  ...
  graph_dir_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
...
inline void TensorForestParams::set_graph_dir(const char* value) {
  ...
  graph_dir_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
...
inline void TensorForestParams::set_graph_dir(const char* value, size_t size) {
  ...
  graph_dir_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
...
inline std::string* TensorForestParams::mutable_graph_dir() {
  ...
  return graph_dir_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* TensorForestParams::release_graph_dir() {
  ...
  return graph_dir_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void TensorForestParams::set_allocated_graph_dir(std::string* graph_dir) {
  if (graph_dir != nullptr) {
    
  } else {
    
  }
  graph_dir_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), graph_dir);
...
inline ::PROTOBUF_NAMESPACE_ID::int32 TensorForestParams::num_select_features() const {
...
inline void TensorForestParams::set_num_select_features(::PROTOBUF_NAMESPACE_ID::int32 value) {
...
inline ::PROTOBUF_NAMESPACE_ID::int32 TensorForestParams::num_classes_to_track() const {
...
inline void TensorForestParams::set_num_classes_to_track(::PROTOBUF_NAMESPACE_ID::int32 value) {
...
#include "protobuf/port_undef.inc"
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_tensor_5fforest_5fparams_2eproto
