...
#ifndef _HEYU_EIGENVALUEVECTOR_INL
#define _HEYU_EIGENVALUEVECTOR_INL

//约化对称阵为对称三对角阵的豪斯荷尔德变换法
template <class _Ty>
int HouseholderTransform(matrix<_Ty>& a, matrix<_Ty>& q, valarray<_Ty>& b, valarray<_Ty>& c)
{
	int j, k, stRank;
    _Ty h, f, g, h2;
...
//实对称阵特征值及特征向量雅可比法
template <class _Ty>
int EigenvalueVectorRealSymmetryJacobi(matrix<_Ty>& a, matrix<_Ty>& v, _Ty eps, int jt)
{
...
//实对称阵特征值及特征向量雅可比过关法
template <class _Ty>
int EigenvalueVectorRealSymmetryJacobiB(matrix<_Ty>& a, matrix<_Ty>& v, _Ty eps)
{
	int j, p, q, stRank;
    _Ty fm, cn, sn, omega, x, y, d;
