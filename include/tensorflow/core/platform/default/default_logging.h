...
class TF_CLASS LogMessage : public std::basic_ostringstream<char> {
 public:
...
class TF_CLASS LogMessageFatal : public LogMessage {
 public:
...
class TF_CLASS CheckOpMessageBuilder {
 public:
