 ...
 */
#ifndef __ANYBASIN_DISTRIBUTED_SIMULATION_BLOCK_STAGE_H__
#define __ANYBASIN_DISTRIBUTED_SIMULATION_BLOCK_STAGE_H__
...
namespace AnyBasin
{
	class ANYBASIN_CLASS CDistributedSimulationStage : DistributedStage
	{
	public:
		CDistributedSimulationStage(void);
		~CDistributedSimulationStage(void);
	};
}
