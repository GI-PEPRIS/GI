...
// source: quantiles.proto

#ifndef GOOGLE_PROTOBUF_INCLUDED_quantiles_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_quantiles_2eproto
...
#include "protobuf/port_def.inc"
#define PROTOBUF_INTERNAL_EXPORT_quantiles_2eproto
...
struct TableStruct_quantiles_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_quantiles_2eproto;
...
class QuantileConfig :
 ...
 public:
  ...
  inline void Swap(QuantileConfig* other) {
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_quantiles_2eproto);
    return ::descriptor_table_quantiles_2eproto.file_level_metadata[kIndexInFileMessages];
  }
 ...
 private:
  ...
  friend struct ::TableStruct_quantiles_2eproto;
};
// -------------------------------------------------------------------
...
class QuantileEntry :
 ...
 public:
  ...
  inline void Swap(QuantileEntry* other) {
    if (other == this) return;
    if (GetArenaNoVirtual() == other->GetArenaNoVirtual()) {
      InternalSwap(other);
    } else {
...
class QuantileSummaryState :
 ...
 public:
  ...
  inline void Swap(QuantileSummaryState* other) {
    if (other == this) return;
    if (GetArenaNoVirtual() == other->GetArenaNoVirtual()) {
      InternalSwap(other);
    } else {
...
class QuantileStreamState :
 ...
 public:
  ...
  inline void Swap(QuantileStreamState* other) {
    if (other == this) return;
    if (GetArenaNoVirtual() == other->GetArenaNoVirtual()) {
      InternalSwap(other);
    } else {
...
#include "protobuf/port_undef.inc"
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_quantiles_2eproto
