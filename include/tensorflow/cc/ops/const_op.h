...
TF_API Output Const(const Scope& scope, const Input::Initializer& val);

TF_API Output ConstFromProto(const Scope& scope, const TensorProto& proto);

TF_API NodeBuilder::NodeOut AsNodeOut(const Scope& scope, const Input& inp);
