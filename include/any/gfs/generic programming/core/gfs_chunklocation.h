 ...
 */
#ifndef ANYWAY_RCF_CORE_RCF_GFS_CHUNK_LOCATION_H
#define ANYWAY_RCF_CORE_RCF_GFS_CHUNK_LOCATION_H
...
namespace anyway
{
	namespace rcf
	{
		...
		**/
		...
		struct gfs_chunklocation
		{
			typedef typename traits::gfs_chunklocation
				<
