...
#ifndef D__TF_TENSORFLOW_TENSORFLOW_CONTRIB_CMAKE_BUILD_TENSORFLOW_CC_OPS_DATA_FLOW_OPS_H_
#define D__TF_TENSORFLOW_TENSORFLOW_CONTRIB_CMAKE_BUILD_TENSORFLOW_CC_OPS_DATA_FLOW_OPS_H_
...
class TF_CLASS AccumulatorApplyGradient {
 public:
...
/// Returns:
/// * the created `Operation`
class TF_CLASS AccumulatorSetGlobalStep {
 public:
...
class TF_CLASS AccumulatorTakeGradient {
 public:
...
class TF_CLASS BarrierIncompleteSize {
 public:
...
/// Returns:
/// * the created `Operation`
class TF_CLASS BarrierInsertMany {
 public:
...
class TF_CLASS BarrierReadySize {
 public:
...
class TF_CLASS BarrierTakeMany {
 public:
...
class TF_CLASS ConditionalAccumulator {
 public:
...
/// Returns:
/// * the created `Operation`
class TF_CLASS DeleteSessionTensor {
 public:
...
class TF_CLASS DynamicPartition {
 public:
...
/// as a string.
class TF_CLASS GetSessionHandle {
 public:
...
class TF_CLASS GetSessionHandleV2 {
 public:
...
class TF_CLASS GetSessionTensor {
 public:
...
class TF_CLASS MapIncompleteSize {
 public:
...
/// * `Output` key
/// * `OutputList` values
class TF_CLASS MapUnstageNoKey {
 public:
...
/// Returns:
/// * the created `Operation`
class TF_CLASS OrderedMapClear {
 public:
...
/// Returns:
/// * `Output`: The size tensor.
class TF_CLASS OrderedMapIncompleteSize {
 public:
...
/// Returns:
/// * the created `Operation`
class TF_CLASS OrderedMapStage {
 public:
...
/// Returns:
/// * `OutputList`: The values tensor.
class TF_CLASS OrderedMapUnstage {
 public:
...
/// * `Output` key
/// * `OutputList` values
class TF_CLASS OrderedMapUnstageNoKey {
 public:
...
/// Returns:
/// * `Output`: The handle to the queue.
class TF_CLASS PaddingFIFOQueue {
 public:
...
/// Returns:
/// * `Output`: The merged tensor.
class TF_CLASS ParallelDynamicStitch {
 public:
...
class TF_CLASS QueueDequeueMany {
 public:
...
/// Returns:
/// * `OutputList`: One or more tensors that were dequeued as a tuple.
class TF_CLASS QueueDequeueUpTo {
 public:
...
/// Returns:
/// * the created `Operation`
class TF_CLASS QueueEnqueueMany {
 public:
...
/// Returns:
/// * `Output`: The is_closed tensor.
class TF_CLASS QueueIsClosedV2 {
 public:
...
/// Returns:
/// * `Output`: The handle to the queue.
class TF_CLASS RandomShuffleQueue {
 public:
...
/// Returns:
/// * the created `Operation`
class TF_CLASS SparseAccumulatorApplyGradient {
 public:
...
class TF_CLASS SparseAccumulatorTakeGradient {
 public:
...
/// Returns:
/// * `Output`: The handle to the accumulator.
class TF_CLASS SparseConditionalAccumulator {
 public:
...
/// Returns:
/// * the created `Operation`
class TF_CLASS TensorArrayClose {
 public:
...
/// `(n1, n2, ..., n(T-1))`.
class TF_CLASS TensorArrayConcat {
 public:
...
class TF_CLASS TensorArrayGather {
 public:
...
/// * `Output` grad_handle
/// * `Output` flow_out
class TF_CLASS TensorArrayGrad {
 public:
...
class TF_CLASS TensorArrayRead {
 public:
...
class TF_CLASS TensorArraySize {
 public:
...
/// Returns:
/// * `Output`: A float scalar that enforces proper chaining of operations.
class TF_CLASS TensorArraySplit {
 public:
...
/// Returns:
/// * `Output`: A float scalar that enforces proper chaining of operations.
class TF_CLASS TensorArrayWrite {
 public:
...
#endif  // D__TF_TENSORFLOW_TENSORFLOW_CONTRIB_CMAKE_BUILD_TENSORFLOW_CC_OPS_DATA_FLOW_OPS_H_
