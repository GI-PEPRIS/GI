 ...
 */
#ifndef __ANYBASIN_ELEMENT_BY_ELEMENT_SOLVER_H__
#define __ANYBASIN_ELEMENT_BY_ELEMENT_SOLVER_H__
...
namespace AnyBasin
{
	class CElementByElementSolver
	{
	public:
		CElementByElementSolver(void);
		~CElementByElementSolver(void);
	};
}
