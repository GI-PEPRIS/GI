...
class TF_CLASS OpKernelContext {
 public:
...
TF_API_NO_C std::unique_ptr<OpKernel> CreateOpKernel(DeviceType device_type,
                                         DeviceBase* device,
                                         Allocator* allocator,
                                         const NodeDef& def,
                                         int graph_def_version, Status* status);
TF_API_NO_C Status CreateOpKernel(DeviceType device_type, DeviceBase* device,
