...
#ifndef D__TF_TENSORFLOW_TENSORFLOW_CONTRIB_CMAKE_BUILD_TENSORFLOW_CC_OPS_RANDOM_OPS_H_
#define D__TF_TENSORFLOW_TENSORFLOW_CONTRIB_CMAKE_BUILD_TENSORFLOW_CC_OPS_RANDOM_OPS_H_
...
class TF_CLASS ParameterizedTruncatedNormal {
 public:
...
/// `[:, ..., :, i0, i1, ...iN]` contains the samples drawn for
/// `rate[i0, i1, ...iN]`.
class TF_CLASS RandomPoissonV2 {
 public:
...
class TF_CLASS RandomUniformInt {
 public:
...
/// values.
class TF_CLASS TruncatedNormal {
 public:
...
#endif  // D__TF_TENSORFLOW_TENSORFLOW_CONTRIB_CMAKE_BUILD_TENSORFLOW_CC_OPS_RANDOM_OPS_H_
