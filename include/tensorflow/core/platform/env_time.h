...
class EnvTime {
 public:
  static const /*constexpr*/ uint64 kMicrosToPicos = 1000ULL * 1000ULL;
  static const /*constexpr*/ uint64 kMicrosToNanos = 1000ULL;
  static const /*constexpr*/ uint64 kMillisToMicros = 1000ULL;
  static const /*constexpr*/ uint64 kMillisToNanos = 1000ULL * 1000ULL;
  static const /*constexpr*/ uint64 kSecondsToMillis = 1000ULL;
  static const /*constexpr*/ uint64 kSecondsToMicros = 1000ULL * 1000ULL;
  static const /*constexpr*/ uint64 kSecondsToNanos = 1000ULL * 1000ULL * 1000ULL;
