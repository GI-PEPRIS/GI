...
#ifndef D__TF_TENSORFLOW_TENSORFLOW_CONTRIB_CMAKE_BUILD_TENSORFLOW_CC_OPS_DATASET_OPS_H_
#define D__TF_TENSORFLOW_TENSORFLOW_CONTRIB_CMAKE_BUILD_TENSORFLOW_CC_OPS_DATASET_OPS_H_
...
/// Returns:
/// * the created `Operation`
class IteratorSetStatsAggregator {
 public:
  IteratorSetStatsAggregator(const ::tensorflow::Scope& scope,
                           ::tensorflow::Input iterator_handle,
                           ::tensorflow::Input stats_aggregator_handle);
  operator ::tensorflow::Operation() const { return operation; }
...
class MapAndBatchDataset {
 public:
  MapAndBatchDataset(const ::tensorflow::Scope& scope, ::tensorflow::Input
                   ...
                   num_parallel_batches, const NameAttrList& f, const
                   DataTypeSlice& output_types, const
                   gtl::ArraySlice<PartialTensorShape>& output_shapes);
  operator ::tensorflow::Output() const { return handle; }
  operator ::tensorflow::Input() const { return handle; }
...
#endif  // D__TF_TENSORFLOW_TENSORFLOW_CONTRIB_CMAKE_BUILD_TENSORFLOW_CC_OPS_DATASET_OPS_H_
