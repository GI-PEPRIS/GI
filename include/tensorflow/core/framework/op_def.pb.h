...
class TF_CLASS OpDef;
class TF_CLASS OpDefDefaultTypeInternal;
...
PROTOBUF_NAMESPACE_OPEN
template<> TF_API_NO_C ::tensorflow::OpDef* Arena::CreateMaybeMessage<::tensorflow::OpDef>(Arena*);
template<> TF_API_NO_C ::tensorflow::OpDef_ArgDef* Arena::CreateMaybeMessage<::tensorflow::OpDef_ArgDef>(Arena*);
template<> TF_API_NO_C ::tensorflow::OpDef_AttrDef* Arena::CreateMaybeMessage<::tensorflow::OpDef_AttrDef>(Arena*);
template<> TF_API_NO_C ::tensorflow::OpDeprecation* Arena::CreateMaybeMessage<::tensorflow::OpDeprecation>(Arena*);
template<> TF_API_NO_C ::tensorflow::OpList* Arena::CreateMaybeMessage<::tensorflow::OpList>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace tensorflow {
...
class OpDef_ArgDef :
 ...
 public:
  ...
  static const/*constexpr*/ int kIndexInFileMessages =    0;//herman
