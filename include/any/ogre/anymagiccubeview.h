 ...
 */
#ifndef __ANYOGRE_MAGIC_CUBE_VIEW_H__
#define __ANYOGRE_MAGIC_CUBE_VIEW_H__
...
namespace AnyOGRE
{
	class ANYOGRE_CLASS CAnyMagicCubeView : public CAnyOgreSampleView
	{
	...
	public:
		...
		*
		**/
		CAnyMagicCubeView(const CAnyContourCubeView::MeshVector &meshes, const GeometryVector &geometries, const SetupParameter &setup);
		~CAnyMagicCubeView();
