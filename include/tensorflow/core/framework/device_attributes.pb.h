...
PROTOBUF_NAMESPACE_OPEN
template<> TF_API_NO_C ::tensorflow::DeviceAttributes* Arena::CreateMaybeMessage<::tensorflow::DeviceAttributes>(Arena*);
template<> TF_API_NO_C ::tensorflow::DeviceLocality* Arena::CreateMaybeMessage<::tensorflow::DeviceLocality>(Arena*);
template<> TF_API_NO_C ::tensorflow::InterconnectLink* Arena::CreateMaybeMessage<::tensorflow::InterconnectLink>(Arena*);
template<> TF_API_NO_C ::tensorflow::LocalLinks* Arena::CreateMaybeMessage<::tensorflow::LocalLinks>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace tensorflow {
...
class TF_CLASS DeviceAttributes :
