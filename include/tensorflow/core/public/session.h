...
/*TF_API*/ Status NewSession(const SessionOptions& options, Session** out_session);
...
TF_API Status Reset(const SessionOptions& options,
...
TF_API Session* NewSession(const SessionOptions& options);
