...
#ifndef _HEYU_EIGENVALUEVECTOR_H		//避免多次编译
#define _HEYU_EIGENVALUEVECTOR_H

#include "heyu_matrix.h"		//矩阵类及相关函数等的定义
#include "heyu_comm.h"		//公共头文件
...
#include "heyu_eigenvaluevector.inl"		//类及相关函数的定义头文件
