 ...
 */
#ifndef __ANYSDE_GFS_TASK_STUB_H__
#define __ANYSDE_GFS_TASK_STUB_H__

#include "anysde.h"
#include "sdetaskservant.h"
...
namespace AnySDE
{
	...
	*
	**/
	class ANYSDE_CLASS CSdeTaskStub : public CGFSChunkStub
	{
		typedef RcfClient<I_AnySdeTask> ServiceStub;
