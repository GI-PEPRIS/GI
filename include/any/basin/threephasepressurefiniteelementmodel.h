 ...
 */
#ifndef __ANYBASIN_HYPER_THREE_PHASE_PRESSURE_FINITE_ELEMENT_MODEL_H__
#define __ANYBASIN_HYPER_THREE_PHASE_PRESSURE_FINITE_ELEMENT_MODEL_H__
...
namespace AnyBasin
{
	...
	*
	**/
	class CThreePhasePressureFiniteElementModel : public CHyperFiniteElementModel
	{
	public:
		CThreePhasePressureFiniteElementModel(CAnyHyperBasinSimulator *simulator);
		~CThreePhasePressureFiniteElementModel();
