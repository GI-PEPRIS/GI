 ...
 */
#ifndef __ANYBASIN_HYPER_SATURATION_FINITE_ELEMENT_MODEL_H__
#define __ANYBASIN_HYPER_SATURATION_FINITE_ELEMENT_MODEL_H__
...
namespace AnyBasin
{
	...
	*
	**/
	class CSaturationFiniteElementModel : public CHyperFiniteElementModel
	{
	public:
		//
		enum SaturationType
	...
	public:
		CSaturationFiniteElementModel(CAnyHyperBasinSimulator *simulator, short staturation_type);
		~CSaturationFiniteElementModel();
