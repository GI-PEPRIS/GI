...
struct ToDataType<float> {
  static const /*constexpr*/ DataType value = DataType::kFloat;
};
template <>
struct ToDataType<double> {
  static const /*constexpr*/ DataType value = DataType::kDouble;
};
template <>
struct ToDataType<Eigen::half> {
  static const /*constexpr*/ DataType value = DataType::kHalf;
};
template <>
struct ToDataType<int8> {
  static const /*constexpr*/ DataType value = DataType::kInt8;
};
template <>
struct ToDataType<int32> {
  static const /*constexpr*/ DataType value = DataType::kInt32;
};
