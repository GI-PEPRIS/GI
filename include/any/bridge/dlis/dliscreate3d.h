 ...
 */
#ifndef __ANYBRIDGE_DLISCREATE3D_H__
#define __ANYBRIDGE_DLISCREATE3D_H__
...
namespace AnyBridge
{
	...
	*
	**/
	class ANYBRIDGE_CLASS CDlisCreate3d
	{
	public:
		struct Slf_CURVE
		{
	...
	public:
		...
		**/
		...
		bool Create3DImage(float *src,int Row,int Col,float D3Angle,float *dst,float *ZBuffer,int npMax);
		bool Create3DImage(short *src,int Row,int Col,float D3Angle,short *dst,float *ZBuffer,int npMax);
	public:
		float m_D3Angle;
		int m_SelectDataBlock;
		float m_pStDep;
		float m_pEnDep;
	public:
