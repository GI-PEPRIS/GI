 ...
 */
#ifndef __ANYDB_SQLITE_CONNECTION_H__
#define __ANYDB_SQLITE_CONNECTION_H__

#include "sqlite3.h"
// Refer to EXPORT
#include "anydb.h"
#include "anysqliteaccessorimpl.h"
...
namespace AnyDB
{
	...
	*
	*/
	class ANYDB_CLASS CAnySqliteConnection
	{
		/*!
		*
		**/
		...
		**/
		...
		friend class CAnySqliteRecordset;
	...
	protected:
		...
		*
		**/
		CAnySqliteConnection(const DBSourceDesc &sourcen, CAnySqliteAccessorImpl* parent);

		/*!
		*
		**/
		~CAnySqliteConnection();
	...
	protected:
		...
		*
		**/
		sqlite3_stmt* CAnySqliteConnection::Execute(const char *sql,bool &result, _variant_t& ra=_variant_t(0L));
	...
	protected:
		...
		sqlite3_stmt* m_connection_stmt;
		//
		string m_adoSource;
		//sourceType
		...
		CAnySqliteAccessorImpl* m_parent;
