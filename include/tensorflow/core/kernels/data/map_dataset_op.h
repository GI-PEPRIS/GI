...
class MapDatasetOp : public UnaryDatasetOpKernel {
 public:
  ...
  static const /*constexpr*/ const char kDatasetType[] = "Map";
  static const /*constexpr*/ const char kInputDataset[] = "input_dataset";
  static const /*constexpr*/ const char kOtherArguments[] = "other_arguments";
  static const /*constexpr*/ const char kF[] = "f";
  static const /*constexpr*/ const char kTarguments[] = "Targuments";
  static const /*constexpr*/ const char kOutputTypes[] = "output_types";
  static const /*constexpr*/ const char kOutputShapes[] = "output_shapes";
  static const /*constexpr*/ const char kUseInterOpParallelism[] =
      "use_inter_op_parallelism";
  static const /*constexpr*/ const char kPreserveCardinality[] = "preserve_cardinality";
