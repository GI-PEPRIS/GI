...
class MklCPUAllocator : public Allocator {
 public:
  ...
  static const /*constexpr*/ const char* kMaxLimitStr = "TF_MKL_ALLOC_MAX_BYTES";

  /// Default upper limit on allocator size - 64GB
  static const /*constexpr*/ size_t kDefaultMaxLimit = 64LL << 30;
 ...
 private:
  ...
  // Name
  static const /*constexpr*/ const char* kName = "mklcpu";

  // The alignment that we need for the allocations
  static const /*constexpr*/ const size_t kAlignment = 64;
  ...
  static const /*constexpr*/ const size_t kSmallAllocationsThreshold = 4096;
