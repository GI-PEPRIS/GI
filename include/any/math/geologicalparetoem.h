 ...
 */
#ifndef __ANYMATH_PARETO_EM__ALGORITHM_H__
#define __ANYMATH_PARETO_EM__ALGORITHM_H__
...
namespace AnyMath
{
	...
	*
	**/
	class ANYMATH_CLASS CGeologicalParetoEM : public CAnyExpectationMaximization
	{
	public:
		//
		//
