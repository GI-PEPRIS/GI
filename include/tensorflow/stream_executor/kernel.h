...
class TypedKernel : public KernelBase {
 public:
  static const /*constexpr*/ size_t kNumberOfParameters = sizeof...(Params);
...
struct KernelInvocationChecker {
  ...
  static const /*constexpr*/ bool kLengthMatches =
  ...
  static const /*constexpr*/ int kTupleLength =
  ...
  static const /*constexpr*/ bool CompatibleNoAssert() {
  ...
  template <typename ParamT, typename ArgT, bool kShouldStaticAssert,
            int kArgumentNumber>
  static const /*constexpr*/ bool Compatible() {
    static_assert(
  ...
  static const /*constexpr*/ bool CheckParam(
  ...
  // things like tests.
  static const /*constexpr*/ bool CheckAllNoStaticAssert() {
  ...
  // error.
  static const /*constexpr*/ bool CheckAllStaticAssert() {
...
struct KernelParamsOk {
  static const /*constexpr*/ bool kResult = false;
};

// See above.
template <typename... Params, typename... Args>
struct KernelParamsOk<TypedKernel<Params...>, Args...> {
  static const /*constexpr*/ bool kResult = KernelInvocationChecker<
