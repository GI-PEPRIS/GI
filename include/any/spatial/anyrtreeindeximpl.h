 ...
 */
#ifndef __ANYINDEX_RTREEINDEXIMPL_H__
#define __ANYINDEX_RTREEINDEXIMPL_H__
...
namespace AnyIndex
{
    ...
    **/
    ...
    public:
		...
		*
		*/
		virtual void Query(const AnyGeometry::CAnyBoundable *bound, CAnyRTreeIndex::ItemVector &items) = 0;

		/*!
		* the items that are matched are the items in quads which
		* overlap the search envelope
		*/
		virtual void Query(const AnyGeometry::CAnyBoundable *bound, CAnyGeometryVisitor &visitor, CAnyRTreeIndex::ItemVector &items) = 0;
    };
}
#endif
