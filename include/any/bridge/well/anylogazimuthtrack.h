 ...
 */
#ifndef __ANYBRIDGE_LOG_AZIMUTH_TRACK_H__
#define __ANYBRIDGE_LOG_AZIMUTH_TRACK_H__
...
namespace AnyBridge
{
	...
	* also as a decorator
	**/
	class ANYBRIDGE_CLASS CAnyLogAzimuthTrack : public CAnyLogTrackComponent
	{
	public:
		//
		//
	...
	public:
		...
		std::vector<std::vector<double> > m_azimuths;//方位角，单位：度
