...
namespace io {
namespace internal {
TF_API string JoinPathImpl(std::initializer_list<tensorflow::StringPiece> paths);
}
...
TF_API bool IsAbsolutePath(tensorflow::StringPiece path);

// Returns the part of the path before the final "/".  If there is a single
// leading "/" in the path, the result will be the leading "/".  If there is
// no "/" in the path, the result is the empty prefix of the input.
TF_API tensorflow::StringPiece Dirname(tensorflow::StringPiece path);

// Returns the part of the path after the final "/".  If there is no
// "/" in the path, the result is the same as the input.
TF_API tensorflow::StringPiece Basename(tensorflow::StringPiece path);

// Returns the part of the basename of path after the final ".".  If
// there is no "." in the basename, the result is empty.
TF_API tensorflow::StringPiece Extension(tensorflow::StringPiece path);
...
TF_API void ParseURI(tensorflow::StringPiece uri, tensorflow::StringPiece* scheme,
...
// return the path.
TF_API string CreateURI(tensorflow::StringPiece scheme, tensorflow::StringPiece host,
                 tensorflow::StringPiece path);

// Creates a temporary file name with an extension.
TF_API string GetTempFilename(const string& extension);
