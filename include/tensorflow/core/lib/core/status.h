...
class TF_CLASS Status {
 public:
  /// Create a success status.
  Status() { state_ = nullptr; } //herman
...
inline Status::Status(const Status& s)
    : state_((s.state_ == nullptr/*NULL*/) ? nullptr/*NULL*/ : new State(*s.state_)) {}//herman
...
TF_API extern tensorflow::string* TfCheckOpHelperOutOfLine(
