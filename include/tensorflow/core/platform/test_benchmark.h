...
TF_API void RunBenchmarks();
TF_API void SetLabel(const std::string& label);
TF_API void BytesProcessed(int64);
TF_API void ItemsProcessed(int64);
TF_API void StartTiming();
TF_API void StopTiming();
TF_API void UseRealTime();
