...
TF_API_NO_C bool safe_strto32_base(absl::string_view text, int32_t* value, int base);
TF_API_NO_C bool safe_strto64_base(absl::string_view text, int64_t* value, int base);
TF_API_NO_C bool safe_strtou32_base(absl::string_view text, uint32_t* value, int base);
TF_API_NO_C bool safe_strtou64_base(absl::string_view text, uint64_t* value, int base);
...
TF_API_NO_C char* FastIntToBuffer(int32_t, char*);
TF_API_NO_C char* FastIntToBuffer(uint32_t, char*);
TF_API_NO_C char* FastIntToBuffer(int64_t, char*);
TF_API_NO_C char* FastIntToBuffer(uint64_t, char*);
