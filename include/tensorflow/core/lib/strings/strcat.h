...
TF_API_NO_C string StrCat(const AlphaNum &a) TF_MUST_USE_RESULT;
TF_API_NO_C string StrCat(const AlphaNum &a, const AlphaNum &b) TF_MUST_USE_RESULT;
TF_API_NO_C string StrCat(const AlphaNum &a, const AlphaNum &b,
              const AlphaNum &c) TF_MUST_USE_RESULT;
TF_API_NO_C string StrCat(const AlphaNum &a, const AlphaNum &b, const AlphaNum &c,
              const AlphaNum &d) TF_MUST_USE_RESULT;

namespace internal {

// Do not call directly - this is not part of the public API.
TF_API string CatPieces(std::initializer_list<StringPiece> pieces);
TF_API void AppendPieces(string *dest, std::initializer_list<StringPiece> pieces);
