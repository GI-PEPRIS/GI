...
struct traits<TensorMirrorPadOp<PaddingDimensions, XprType>>
  ...
  static const /*constexpr*/ int NumDimensions = XprTraits::NumDimensions;
  static const /*constexpr*/ int Layout = XprTraits::Layout;
};
...
struct TensorEvaluator<const TensorMirrorPadOp<PaddingDimensions, ArgType>,
  ...
  static const /*constexpr*/ int Dims = internal::array_size<PaddingDimensions>::value;
