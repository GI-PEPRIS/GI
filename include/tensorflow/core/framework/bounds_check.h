...
//#include "thrid_party/eigen3/Core" //herman
...
/*EIGEN_ALWAYS_INLINE EIGEN_DEVICE_FUNC*/ bool FastBoundsCheck(const Ta index,  //herman
                                                           const Tb limit) {
...
template <typename T>
/*EIGEN_ALWAYS_INLINE EIGEN_DEVICE_FUNC*/ const T SubtleMustCopy(const T &x) { //herman
