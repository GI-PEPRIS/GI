...
TF_API_NO_C bool FormatFromString(const string& format_str, TensorFormat* format);

// Parse tensor format from the given string.
// Return true if the parsing succeeds, and false if it fails.
TF_API_NO_C  bool FilterFormatFromString(const string& format_str,
                            FilterTensorFormat* format);

// Convert a tensor format into string.
TF_API_NO_C string ToString(TensorFormat format);

// Convert a filter tensor format into string.
TF_API_NO_C string ToString(FilterTensorFormat format);
