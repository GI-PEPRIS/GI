 ...
 */
#ifndef __ANYMATH_CONSTANT_DISTRIBUTION_H__
#define __ANYMATH_CONSTANT_DISTRIBUTION_H__
...
namespace AnyMath
{
	...
	*
	**/
	class CConstantDistribution : public CAnyDistributionStrategy
	{
	public:
		//
		//
		...
		*
		**/
		CConstantDistribution(CAnyDistributionStrategy *host = 0);

		/*!
		*
		**/
		virtual ~CConstantDistribution();
