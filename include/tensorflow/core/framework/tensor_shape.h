...
template <class Shape>
class TF_CLASS TensorShapeBase : public TensorShapeRep {
 public:
 ...
 private:
  ...
  static const /*constexpr*/ bool kIsPartial =
...
class TF_CLASS TensorShape : public TensorShapeBase<TensorShape> {
 public:
