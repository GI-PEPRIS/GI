...
TF_API_NO_C string SummarizeGraphDef(const GraphDef& graph_def);
...
TF_API_NO_C Status ValidateExternalGraphDefSyntax(const GraphDef& graph_def);
...
TF_API_NO_C Status AddDefaultAttrsToGraphDef(GraphDef* graph_def,
...
TF_API_NO_C Status RemoveNewDefaultAttrsFromGraphDef(
...
TF_API_NO_C void OpsUsedByGraph(const GraphDef& graph_def,
...
TF_API_NO_C Status StrippedOpListForGraph(const GraphDef& graph_def,
                              const OpRegistryInterface& op_registry,
