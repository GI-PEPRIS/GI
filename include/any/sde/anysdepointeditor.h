 ...
 */
#ifndef __ANYSDE_SDE_GEOMETRY_POINT_EDITOR_H__
#define __ANYSDE_SDE_GEOMETRY_POINT_EDITOR_H__
...
namespace AnySDE
{
	...
	*
	**/
	class ANYSDE_CLASS CAnySdePointEditor : public CAnySdeGeometryEditor
	{
	public:
		//
		//
		...
		*
		**/
		CAnySdePointEditor(CAnyView &curView, CAnySdeGeometryLayer &layer);
