 ...
 */
#ifndef __ANYMATH_DOUBLE_TRUNCATED_PARETO_DISTRIBUTION_H__
#define __ANYMATH_DOUBLE_TRUNCATED_PARETO_DISTRIBUTION_H__
...
namespace AnyMath
{
	...
	* TSP
	**/
	class ANYMATH_CLASS CTruncatedParetoDistribution : public CAnyDistributionStrategy
	{
	public:
		//
		//
		...
		*
		**/
		CTruncatedParetoDistribution(CAnyDistributionStrategy *host = 0);

		/*!
		*
		**/
		~CTruncatedParetoDistribution();
