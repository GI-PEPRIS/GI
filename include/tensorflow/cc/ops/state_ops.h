...
#ifndef D__TF_TENSORFLOW_TENSORFLOW_CONTRIB_CMAKE_BUILD_TENSORFLOW_CC_OPS_STATE_OPS_H_
#define D__TF_TENSORFLOW_TENSORFLOW_CONTRIB_CMAKE_BUILD_TENSORFLOW_CC_OPS_STATE_OPS_H_
...
class TF_CLASS DestroyTemporaryVariable {
 public:
...
class TF_CLASS IsVariableInitialized {
 public:
...
/// * `Output`: A copy of the input before increment. If nothing else modifies the
/// input, the values produced will all be distinct.
class TF_CLASS ResourceCountUpTo {
 public:
...
class TF_CLASS ResourceScatterNdUpdate {
 public:
...
class TF_CLASS ScatterNdUpdate {
 public:
...
class TF_CLASS TemporaryVariable {
 public:
...
#endif  // D__TF_TENSORFLOW_TENSORFLOW_CONTRIB_CMAKE_BUILD_TENSORFLOW_CC_OPS_STATE_OPS_H_
