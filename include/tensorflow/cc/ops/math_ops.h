...
#ifndef D__TF_TENSORFLOW_TENSORFLOW_CONTRIB_CMAKE_BUILD_TENSORFLOW_CC_OPS_MATH_OPS_H_
#define D__TF_TENSORFLOW_TENSORFLOW_CONTRIB_CMAKE_BUILD_TENSORFLOW_CC_OPS_MATH_OPS_H_
...
/// Returns:
/// * `Output`: The z tensor.
class TF_CLASS ApproximateEqual {
 public:
...
class TF_CLASS CompareAndBitpack {
 public:
...
class TF_CLASS HistogramFixedWidth {
 public:
...
class TF_CLASS QuantizeDownAndShrinkRange {
 public:
...
class TF_CLASS QuantizedMatMul {
 public:
...
class TF_CLASS RequantizationRange {
 public:
...
/// * `Output`: Has same shape as data, except for dimension 0 which
/// has size `k`, the number of segments.
class TF_CLASS SparseSegmentMean {
 public:
...
/// Returns:
/// * `Output`: The output tensor.
class TF_CLASS SparseSegmentMeanGrad {
 public:
...
/// `num_segments`.
class TF_CLASS SparseSegmentMeanWithNumSegments {
 public:
...
/// * `Output`: Has same shape as data, except for dimension 0 which
/// has size `k`, the number of segments.
class TF_CLASS SparseSegmentSqrtN {
 public:
...
/// Returns:
/// * `Output`: The output tensor.
class TF_CLASS SparseSegmentSqrtNGrad {
 public:
...
/// * `Output`: Has same shape as data, except for dimension 0 which
/// has size `k`, the number of segments.
class TF_CLASS SparseSegmentSqrtNWithNumSegments {
 public:
...
/// * `Output`: Has same shape as data, except for dimension 0 which
/// has size `k`, the number of segments.
class TF_CLASS SparseSegmentSum {
 public:
...
class TF_CLASS SparseSegmentSumWithNumSegments {
 public:
...
/// Returns:
/// * `Output`: The z tensor.
class TF_CLASS SquaredDifference {
 public:
...
/// * `Output`: Has same shape as data, except for dimension 0 which
/// has size `num_segments`.
class TF_CLASS UnsortedSegmentMax {
 public:
...
/// `num_segments`.
class TF_CLASS UnsortedSegmentSum {
 public:
...
#endif  // D__TF_TENSORFLOW_TENSORFLOW_CONTRIB_CMAKE_BUILD_TENSORFLOW_CC_OPS_MATH_OPS_H_
