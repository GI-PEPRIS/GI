 ...
 */
#ifndef __ANYBRIDGE_LOG_SPECTRUM_TRACK_H__
#define __ANYBRIDGE_LOG_SPECTRUM_TRACK_H__
...
namespace AnyBridge
{
	...
	* also as a decorator
	**/
	class ANYBRIDGE_CLASS CAnyLogSpectrumTrack : public CAnyLogTrackComponent
	{
	public:
		//
		//
	...
	public:
		//
		std::vector<std::vector<AnyTraceSample> > m_samples;//里面一层的数据为同一深度的一组数据
		double m_scale;//谱峰值所占的高度比例
