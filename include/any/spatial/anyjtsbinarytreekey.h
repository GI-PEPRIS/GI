 ...
 */
#ifndef __ANYINDEX_JTS_BINARYTREEKEY_H__
#define __ANYINDEX_JTS_BINARYTREEKEY_H__
...
namespace AnyIndex
{
	...
	* is the power of two for the size of the node envelope/interval
    ...
    public:
        ...
        *
        **/
        CAnyJTSBinaryTreeKey(const CAnyInterval &interval);

        /*!
        *
        **/
        ~CAnyJTSBinaryTreeKey();
