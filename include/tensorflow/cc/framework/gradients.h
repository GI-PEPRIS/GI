...
TF_API_NO_C Status AddSymbolicGradients(const Scope& scope,
...
TF_API_NO_C Status AddSymbolicGradients(const Scope& scope, //herman
                            const std::vector<Output>& outputs,
                            const std::vector<Output>& inputs,
                            std::vector<Output>* grad_outputs); //herman
