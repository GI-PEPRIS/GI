...
// device memory.
class TF_CLASS Allocator {
 public:
  // Align to 64 byte boundary.
  static const/*constexpr*/ size_t kAllocatorAlignment = 64; //herman
...
// allocator.
class TF_CLASS AllocatorWrapper : public Allocator {
 public:
...
TF_API Allocator* cpu_allocator_base();
...
// call it directly.
TF_API Allocator* cpu_allocator(int numa_node = port::kNUMANoAffinity);
...
TF_API void EnableCPUAllocatorFullStats(bool enable);
TF_API bool CPUAllocatorFullStatsEnabled();
