...
#ifndef GOOGLE_PROTOBUF_INCLUDED_split_5finfo_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_split_5finfo_2eproto
...
#include "tree_config.pb.h"
// @@protoc_insertion_point(includes)
#include "protobuf/port_def.inc"
#define PROTOBUF_INTERNAL_EXPORT_split_5finfo_2eproto
...
struct TableStruct_split_5finfo_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_split_5finfo_2eproto;
...
class SplitInfo :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_split_5finfo_2eproto);
    return ::descriptor_table_split_5finfo_2eproto.file_level_metadata[kIndexInFileMessages];
  }
  ...
  enum : int {
    kSplitNodeFieldNumber = 1,
    kLeftChildFieldNumber = 2,
    kRightChildFieldNumber = 3,
  };
 ...
 private:
  ...
  friend struct ::TableStruct_split_5finfo_2eproto;
};
// -------------------------------------------------------------------
...
class ObliviousSplitInfo :
 ...
 public:
  ...
  inline void Swap(ObliviousSplitInfo* other) {
    if (other == this) return;
    if (GetArenaNoVirtual() == other->GetArenaNoVirtual()) {
      InternalSwap(other);
    } else {
  ...
  enum : int {
    ...
    kChildrenParentIdFieldNumber = 3,
    kSplitNodeFieldNumber = 1,
  };
...
#include "protobuf/port_undef.inc"
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_split_5finfo_2eproto
