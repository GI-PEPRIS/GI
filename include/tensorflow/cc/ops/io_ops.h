...
#ifndef D__TF_TENSORFLOW_TENSORFLOW_CONTRIB_CMAKE_BUILD_TENSORFLOW_CC_OPS_IO_OPS_H_
#define D__TF_TENSORFLOW_TENSORFLOW_CONTRIB_CMAKE_BUILD_TENSORFLOW_CC_OPS_IO_OPS_H_
...
class TF_CLASS FixedLengthRecordReader {
 public:
...
class TF_CLASS MergeV2Checkpoints {
 public:
...
class TF_CLASS ReaderNumWorkUnitsCompleted {
 public:
...
/// Returns:
/// * the created `Operation`
class TF_CLASS ReaderRestoreState {
 public:
...
class TF_CLASS ReaderSerializeState {
 public:
...
class TF_CLASS ShardedFilename {
 public:
...
/// Returns:
/// * `Output`: The filename tensor.
class TF_CLASS ShardedFilespec {
 public:
...
/// Returns:
/// * `Output`: The handle to reference the Reader.
class TF_CLASS WholeFileReader {
 public:
...
#endif  // D__TF_TENSORFLOW_TENSORFLOW_CONTRIB_CMAKE_BUILD_TENSORFLOW_CC_OPS_IO_OPS_H_
