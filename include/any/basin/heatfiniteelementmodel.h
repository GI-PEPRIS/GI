 ...
 */
#ifndef __ANYBASIN_HYPER_HEAT_FINITE_ELEMENT_MODEL_H__
#define __ANYBASIN_HYPER_HEAT_FINITE_ELEMENT_MODEL_H__
...
namespace AnyBasin
{
	...
	*
	**/
	class CHeatFiniteElementModel : public CHyperFiniteElementModel
	{
	public:
		CHeatFiniteElementModel(CAnyHyperBasinSimulator *simulator);
		~CHeatFiniteElementModel();
