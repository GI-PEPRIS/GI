 ...
 */
#ifndef __ANYSDE_SDE_GEOMETRY_POLYGON_EDITOR_H__
#define __ANYSDE_SDE_GEOMETRY_POLYGON_EDITOR_H__
...
namespace AnySDE
{
	...
	*
	**/
	class ANYSDE_CLASS CAnySdePolygonEditor : public CAnySdeGeometryEditor
	{
	public:
		//
		//
		...
		*
		**/
		CAnySdePolygonEditor(CAnyView &curView, CAnySdeGeometryLayer &layer);

		/*!
		*
		**/
		~CAnySdePolygonEditor();
