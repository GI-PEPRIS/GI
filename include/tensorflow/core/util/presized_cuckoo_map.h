...
class PresizedCuckooMap {
 ...
 private:
  static const /*constexpr*/ int kSlotsPerBucket = 4;
  ...
  static const /*constexpr*/ uint8 kMaxBFSPathLen = 5;
  ...
  static const /*constexpr*/ int kMaxQueueSize = 682;
  static const /*constexpr*/ int kVisitedListSize = 170;

  static const /*constexpr*/ int kNoSpace = -1;  // SpaceAvailable return
  static const /*constexpr*/ uint64 kUnusedSlot = ~(0ULL);
