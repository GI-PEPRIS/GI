 ...
 */
#ifndef __ANYBASE_LOKI_FUNCTOR_H__
#define __ANYBASE_LOKI_FUNCTOR_H__
...
/*!
* Describes generalized functors, a powerful abstraction that allows decoupled interobject communication. 
* Generalized functors are especially useful in designs that need requests to be stored in objects. 
* Generalized functor is any processing invocation that C++ allows, encapsulated as a typesafe first-class object. 
* In a more detailed definition, a generalized functor:
*
* 1) Encapsulates any processing invocation because it accepts pointers to simple functions, pointers to member functions, 
*    functors, and even other generalized functors - together with some or all of their respective arguments.
* 2) Is typesafe because it never matches the wrong argument types to the wrong functions.
* 3) Is an object with value semantics because it fully supports copying, assignment, and pass by value. 
	...
	namespace Loki
	{
		...
		**/
            ...
            : public SmallValueObject<ThreadingModel>
        {
			...
			*
			**/
            inline FunctorImplBase(const FunctorImplBase&) : SmallValueObject<ThreadingModel>() 
			{
			}
#endif
			// Generic calling function style which can change its return type and
			// at most support to pass 15 parameters
			...
			**/
			...
			static U *Clone(U *pObj)
			{
				...
				U*clonedObject = static_cast<U*>(pObj->DoClone());
				assert(typeid(*clonedObject) == typeid(*pObj));
		...
		// Useful Macroes for generalized functor deifnitions
		// ...
		// Implements the DoClone function for a functor implementation
		#define LOKI_DEFINE_CLONE_FUNCTORIMPL(Cls)  virtual Cls* DoClone() const { return new Cls(*this); }


		// Forward class(Full definition): template FunctorImpl
		...
		template <typename R, class TList,  template <class, class> class ThreadingModel = LOKI_DEFAULT_THREADING_NO_OBJ_LEVEL>
		class FunctorImpl;

		// Forward class(Special when there is no any para): template FunctorImpl
		// Specialization for 0 (zero) parameters
		template <typename R, template <class, class> class ThreadingModel>
		class FunctorImpl<R, NullType, ThreadingModel> : public FunctorImplBase<R, ThreadingModel>
		{
		public:
			typedef R ResultType;
		...
		// Forward class(Special when unfolding typelist with one para) template FunctorImpl
		// Specialization for 1 parameter
		template <typename R, typename P1, template <class, class> class ThreadingModel>
		class FunctorImpl<R, Seq<P1>, ThreadingModel> : public FunctorImplBase<R, ThreadingModel>
		{
		public:
			typedef R ResultType;
		...
		template <typename R, typename P1, typename P2, template <class, class> class ThreadingModel>
		class FunctorImpl<R, Seq<P1, P2>, ThreadingModel> : public FunctorImplBase<R, ThreadingModel>
		{
		public:
			typedef R ResultType;
			typedef typename TypeTraits<P1>::ParameterType Parm1;
		...
		template <typename R, typename P1, typename P2, typename P3, template <class, class> class ThreadingModel>
		class FunctorImpl<R, Seq<P1, P2, P3>, ThreadingModel> : public FunctorImplBase<R, ThreadingModel>
		{
		public:
			typedef R ResultType;
			typedef typename TypeTraits<P1>::ParameterType Parm1;
		...
		template <typename R, typename P1, typename P2, typename P3, typename P4, template <class, class> class ThreadingModel>
		class FunctorImpl<R, Seq<P1, P2, P3, P4>, ThreadingModel> : public FunctorImplBase<R, ThreadingModel>
		{
		public:
			typedef R ResultType;
			typedef typename TypeTraits<P1>::ParameterType Parm1;
		...
		template <typename R, typename P1, typename P2, typename P3, typename P4, typename P5, template <class, class> class ThreadingModel>
		class FunctorImpl<R, Seq<P1, P2, P3, P4, P5>, ThreadingModel> : public FunctorImplBase<R, ThreadingModel>
		{
		public:
			typedef R ResultType;
			typedef typename TypeTraits<P1>::ParameterType Parm1;
		...
		template <typename R, typename P1, typename P2, typename P3, typename P4, typename P5, typename P6, template <class, class> class ThreadingModel>
		class FunctorImpl<R, Seq<P1, P2, P3, P4, P5, P6>, ThreadingModel> : public FunctorImplBase<R, ThreadingModel>
		{
		public:
			typedef R ResultType;
			typedef typename TypeTraits<P1>::ParameterType Parm1;
		...
		template <typename R, typename P1, typename P2, typename P3, typename P4, typename P5, typename P6, typename P7, template <class, class> class ThreadingModel>
		class FunctorImpl<R, Seq<P1, P2, P3, P4, P5, P6, P7>, ThreadingModel> : public FunctorImplBase<R, ThreadingModel>
		{
		public:
			typedef R ResultType;
			typedef typename TypeTraits<P1>::ParameterType Parm1;
			...
			virtual ResultType operator()(Parm1, Parm2, Parm3, Parm4, Parm5, Parm6, 
				Parm7) = 0;
		};

		// class template FunctorImpl
		// Specialization for 8 parameters
		template <typename R, typename P1, typename P2, typename P3, typename P4, typename P5, typename P6, typename P7, typename P8, template <class, class> class ThreadingModel>
		class FunctorImpl<R, Seq<P1, P2, P3, P4, P5, P6, P7, P8>, ThreadingModel> : public FunctorImplBase<R, ThreadingModel>
		{
		public:
			typedef R ResultType;
			typedef typename TypeTraits<P1>::ParameterType Parm1;
		...
		template <typename R, typename P1, typename P2, typename P3, typename P4, typename P5, typename P6, typename P7, typename P8, typename P9, template <class, class> class ThreadingModel>
		class FunctorImpl<R, Seq<P1, P2, P3, P4, P5, P6, P7, P8, P9>, ThreadingModel> : public FunctorImplBase<R, ThreadingModel>
		{
		public:
			typedef R ResultType;
			typedef typename TypeTraits<P1>::ParameterType Parm1;
		...
		template <typename R, typename P1, typename P2, typename P3, typename P4, typename P5, typename P6, typename P7, typename P8, typename P9, typename P10, template <class, class> class ThreadingModel>
		class FunctorImpl<R, Seq<P1, P2, P3, P4, P5, P6, P7, P8, P9, P10>, ThreadingModel> : public FunctorImplBase<R, ThreadingModel>
		{
		public:
			typedef R ResultType;
			typedef typename TypeTraits<P1>::ParameterType Parm1;
		...
		template <typename R, typename P1, typename P2, typename P3, typename P4, typename P5, typename P6, typename P7, typename P8, typename P9, typename P10, typename P11, template <class, class> class ThreadingModel>
		class FunctorImpl<R, Seq<P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11>, ThreadingModel> : public FunctorImplBase<R, ThreadingModel>
		{
		public:
			typedef R ResultType;
			typedef typename TypeTraits<P1>::ParameterType Parm1;
		...
		template <typename R, typename P1, typename P2, typename P3, typename P4, typename P5, typename P6, typename P7, typename P8, typename P9, typename P10, typename P11, typename P12, template <class, class> class ThreadingModel>
		class FunctorImpl<R, Seq<P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12>, ThreadingModel> : public FunctorImplBase<R, ThreadingModel>
		{
		public:
			typedef R ResultType;
			typedef typename TypeTraits<P1>::ParameterType Parm1;
		...
		template <typename R, typename P1, typename P2, typename P3, typename P4, typename P5, typename P6, typename P7, typename P8, typename P9, typename P10, typename P11, typename P12, typename P13, template <class, class> class ThreadingModel>
		class FunctorImpl<R, Seq<P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13>, ThreadingModel> : public FunctorImplBase<R, ThreadingModel>
		{
		public:
			typedef R ResultType;
			typedef typename TypeTraits<P1>::ParameterType Parm1;
		...
		template <typename R, typename P1, typename P2, typename P3, typename P4, typename P5, typename P6, typename P7, typename P8, typename P9, typename P10, typename P11, typename P12, typename P13, typename P14, template <class, class> class ThreadingModel>
		class FunctorImpl<R, Seq<P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14>, ThreadingModel> : public FunctorImplBase<R, ThreadingModel>
		{
		public:
			typedef R ResultType;
			typedef typename TypeTraits<P1>::ParameterType Parm1;
		...
		template <typename R, typename P1, typename P2, typename P3, typename P4, typename P5, typename P6, typename P7, typename P8, typename P9, typename P10, typename P11, typename P12, typename P13, typename P14, typename P15, template <class, class> class ThreadingModel>
		class FunctorImpl<R, Seq<P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15>, ThreadingModel> : public FunctorImplBase<R, ThreadingModel>
		{
		public:
			typedef R ResultType;
			typedef typename TypeTraits<P1>::ParameterType Parm1;
		...
		// Specialization for 1 parameter
		template <typename R, typename P1, template <class, class> class ThreadingModel>
		class FunctorImpl<R, TYPELIST_1(P1), ThreadingModel> : public FunctorImplBase<R, ThreadingModel>
		{
		public:
			typedef R ResultType;
			typedef typename TypeTraits<P1>::ParameterType Parm1;
		...
		class FunctorImpl<R, TYPELIST_2(P1, P2), ThreadingModel>
			: public FunctorImplBase<R, ThreadingModel>
		{
		public:
			typedef R ResultType;
			typedef typename TypeTraits<P1>::ParameterType Parm1;
		...
		template <typename R, typename P1, typename P2, typename P3, typename P4,
			...
			template <class, class> class ThreadingModel>
		class FunctorImpl<R, TYPELIST_8(P1, P2, P3, P4, P5, P6, P7, P8), ThreadingModel> : public FunctorImplBase<R, ThreadingModel>
		{
		public:
			typedef R ResultType;
			typedef typename TypeTraits<P1>::ParameterType Parm1;
		...
		template <typename R, typename P1, typename P2, typename P3, typename P4,
			...
			template <class, class> class ThreadingModel>
		class FunctorImpl<R, TYPELIST_9(P1, P2, P3, P4, P5, P6, P7, P8, P9), ThreadingModel> : public FunctorImplBase<R, ThreadingModel>
		{
		public:
			typedef R ResultType;
			typedef typename TypeTraits<P1>::ParameterType Parm1;
		...
		template <typename R, typename P1, typename P2, typename P3, typename P4,
			...
			template <class, class> class ThreadingModel>
		class FunctorImpl<R, TYPELIST_11(P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11), ThreadingModel> : public FunctorImplBase<R, ThreadingModel>
		{
		public:
			typedef R ResultType;
			typedef typename TypeTraits<P1>::ParameterType Parm1;
		...
		template <typename R, typename P1, typename P2, typename P3, typename P4,
			...
			template <class, class> class ThreadingModel>
		class FunctorImpl<R, TYPELIST_12(P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12), ThreadingModel> : public FunctorImplBase<R, ThreadingModel>
		{
		public:
			typedef R ResultType;
			typedef typename TypeTraits<P1>::ParameterType Parm1;
...
#define LOKI_FUNCTION_THROW_BAD_FUNCTION_CALL 
		...
		**/
		...
		struct BinderFirstTraits< Functor<R, TList, ThreadingModel> >
		{
			...
			typedef typename TList::Erase<TList, typename TList::TypeAt<TList, 0>::Result>::Result ParmList;

			typedef typename TList::TypeAt<TList, 0>::Result OriginalParm1;
		...
		*/
		...
		class BinderFirst : public BinderFirstTraits<OriginalFunctor>::Impl
		{
			...
			typedef typename BinderFirstBoundTypeStorage<
								 typename BinderFirstTraits<OriginalFunctor>
								 ::OriginalParm1>
							 ::RefOrValue
					BoundTypeStorage;
		...
		**/
		...
		{
			typedef typename BinderFirstTraits<Fctor>::BoundFunctorType
				Outgoing;
		...
		**/
		...
		public:
			...
			Chainer(const Fun1& fun1, const Fun2& fun2) : m_firstFunction(fun1), m_secondFunction(fun2) {}
			...
			bool operator==(const typename Base::Impl::FunctorImplBaseType& rhs) const
			{
				...
				// if this line gives a compiler error, you are using a function object.
				// you need to implement bool MyFnObj::operator == (const MyFnObj&) const;
				return    m_firstFunction == ((static_cast<const Chainer&> (rhs)).m_secondFunction) &&
						  m_secondFunction == ((static_cast<const Chainer&> (rhs)).m_firstFunction);
			}
		#endif
			...
			ResultType operator()()
			{ return m_firstFunction(), m_secondFunction(); }

			ResultType operator()(Parm1 p1)
			{ return m_firstFunction(p1), m_secondFunction(p1); }
		    
			ResultType operator()(Parm1 p1, Parm2 p2)
			{ return m_firstFunction(p1, p2), m_secondFunction(p1, p2); }
		    
			ResultType operator()(Parm1 p1, Parm2 p2, Parm3 p3)
			{ return m_firstFunction(p1, p2, p3), m_secondFunction(p1, p2, p3); }
		    
			ResultType operator()(Parm1 p1, Parm2 p2, Parm3 p3, Parm4 p4)
			{ return m_firstFunction(p1, p2, p3, p4), m_secondFunction(p1, p2, p3, p4); }
		    
			ResultType operator()(Parm1 p1, Parm2 p2, Parm3 p3, Parm4 p4, Parm5 p5)
			{ return m_firstFunction(p1, p2, p3, p4, p5), m_secondFunction(p1, p2, p3, p4, p5); }
		    
			ResultType operator()(Parm1 p1, Parm2 p2, Parm3 p3, Parm4 p4, Parm5 p5,
				Parm6 p6)
			{ return m_firstFunction(p1, p2, p3, p4, p5, p6), m_secondFunction(p1, p2, p3, p4, p5, p6); }
		    
			ResultType operator()(Parm1 p1, Parm2 p2, Parm3 p3, Parm4 p4, Parm5 p5,
				Parm6 p6, Parm7 p7)
			{
				return m_firstFunction(p1, p2, p3, p4, p5, p6, p7),
					m_secondFunction(p1, p2, p3, p4, p5, p6, p7);
			}
		    
			ResultType operator()(Parm1 p1, Parm2 p2, Parm3 p3, Parm4 p4, Parm5 p5,
				Parm6 p6, Parm7 p7, Parm8 p8)
			{
				return m_firstFunction(p1, p2, p3, p4, p5, p6, p7, p8),
					m_secondFunction(p1, p2, p3, p4, p5, p6, p7, p8);
			}
		    
			ResultType operator()(Parm1 p1, Parm2 p2, Parm3 p3, Parm4 p4, Parm5 p5,
				Parm6 p6, Parm7 p7, Parm8 p8, Parm9 p9)
			{
				return m_firstFunction(p1, p2, p3, p4, p5, p6, p7, p8, p9),
					m_secondFunction(p1, p2, p3, p4, p5, p6, p7, p8, p9);
			}
		    
			ResultType operator()(Parm1 p1, Parm2 p2, Parm3 p3, Parm4 p4, Parm5 p5,
				Parm6 p6, Parm7 p7, Parm8 p8, Parm9 p9, Parm10 p10)
			{
				return m_firstFunction(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10),
					m_secondFunction(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10);
			}
		    
			ResultType operator()(Parm1 p1, Parm2 p2, Parm3 p3, Parm4 p4, Parm5 p5,
				Parm6 p6, Parm7 p7, Parm8 p8, Parm9 p9, Parm10 p10, Parm11 p11)
			{
				return m_firstFunction(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11),
					m_secondFunction(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11);
			}
			...
			ResultType operator()(Parm1 p1, Parm2 p2, Parm3 p3, Parm4 p4, Parm5 p5,
				...
				Parm12 p12)
			{
				return m_firstFunction(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12),
					m_secondFunction(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12);
			}
			...
			ResultType operator()(Parm1 p1, Parm2 p2, Parm3 p3, Parm4 p4, Parm5 p5,
				...
				Parm12 p12, Parm13 p13)
			{
				return m_firstFunction(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13),
					m_secondFunction(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13);
			}
		...
		private:
			Fun1 m_firstFunction;
			Fun2 m_secondFunction;
		};
