...
PROTOBUF_NAMESPACE_OPEN
template<> TF_API_NO_C ::tensorflow::AllocationDescription* Arena::CreateMaybeMessage<::tensorflow::AllocationDescription>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace tensorflow {
...
class AllocationDescription :
 ...
 public:
  ...
  virtual ::PROTOBUF_NAMESPACE_ID::uint8* InternalSerializeWithCachedSizesToArray( //herman
