 ...
 */
#ifndef __ANYBRIDGE_DLISCALILLS_H__
#define __ANYBRIDGE_DLISCALILLS_H__
...
namespace AnyBridge
{
	...
	*
	**/
	class ANYBRIDGE_CLASS CDlisCalills
	{
	public:
		struct Slf_CURVE
		{
	...
	public:
		...
		**/
		...
		bool GetCaliCoef(float *mr,int Row,int Col,float *lls,float *caa,float *cbb,int id);
		void lstm0(float *x,float *y,int n,double *aa);
