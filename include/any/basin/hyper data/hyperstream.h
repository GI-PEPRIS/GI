 ...
 */
#ifndef __ANYBASIN_HYPER_STREAM_H__
#define __ANYBASIN_HYPER_STREAM_H__
...
namespace AnyBasin
{
	...
	{  // NOLINT(*)
	 public:
		   ...
		   */
		  static HyperStream *Create(const char *uri,
	...
	class HyperSeekStream: public HyperStream 
	{
	 public:
	  // virtual destructor
	  virtual ~HyperSeekStream(void) {}
	   ...
	   * \return the created stream, can be NULL when allow_null == true and file do not exist
	   */
	  static HyperSeekStream *CreateForRead(const char *uri,
									   bool allow_null = false);
	};
	...
	class HyperInputSplit 
	{
	 public:
	   ...
	   * \sa InputSplit::Type
	   */
	  static HyperInputSplit* Create(const char *uri,
								unsigned part_index,
								unsigned num_parts,
								const char *type);
	};
	...
	class ostream : public std::basic_ostream<char> 
	{
	 public:
	   ...
	   */
	  explicit ostream(HyperStream *stream,
	   ...
	   */
	  inline void set_stream(HyperStream *stream) {
	...
	class istream : public std::basic_istream<char> 
	{
	 public:
	   ...
	   */
	  explicit istream(HyperStream *stream,
					   size_t buffer_size = (1 << 10))
...
#include "hyperserializer.h"
namespace AnyBasin
{
	// implementations of inline functions
	template<typename T>
	inline void HyperStream::Write(const T &data) {
		serializer::Handler<T>::Write(this, data);
	}
	template<typename T>
	inline bool HyperStream::Read(T *out_data) {
		return serializer::Handler<T>::Read(this, out_data);
	}

	// implementations for ostream
	inline void ostream::OutBuf::set_stream(HyperStream *stream) {
	...
	inline void istream::InBuf::set_stream(HyperStream *stream) {
		stream_ = stream;
