...
struct mkldnn_gemm_kernel</*Scalar*/ float, IndexType, OutputMapper,
  ...
  static const /*constexpr*/ int kComputeStrideFromBlockDimensions = -1;
...
class TensorContractionBlocking<float, float, float, StorageIndex,
  ...
  static const /*constexpr*/ float kScaleM = 1.5;
  static const /*constexpr*/ float kScaleN = 1.0;
...
class TensorContractionBlocking<Eigen::QInt32, Eigen::QInt8, Eigen::QUInt8,
  ...
  static const /*constexpr*/ float kScaleM = 1.5;
  static const /*constexpr*/ float kScaleN = 1.5;
  static const /*constexpr*/ float kScaleK = 1.5;
