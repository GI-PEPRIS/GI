...
#ifndef D__TF_TENSORFLOW_TENSORFLOW_CONTRIB_CMAKE_BUILD_TENSORFLOW_CC_OPS_IMAGE_OPS_H_
#define D__TF_TENSORFLOW_TENSORFLOW_CONTRIB_CMAKE_BUILD_TENSORFLOW_CC_OPS_IMAGE_OPS_H_
...
/// Returns:
/// * `Output`: The hue-adjusted image or images.
class TF_CLASS AdjustSaturation {
 public:
...
class TF_CLASS CropAndResizeGradBoxes {
 public:
...
class TF_CLASS CropAndResizeGradImage {
 public:
...
class TF_CLASS DecodeAndCropJpeg {
 public:
...
class TF_CLASS DrawBoundingBoxes {
 public:
...
class TF_CLASS ExtractJpegShape {
 public:
...
class TF_CLASS NonMaxSuppression {
 public:
...
/// * `Output`: A 1-D integer tensor of shape `[M]` representing the selected
/// indices from the boxes tensor, where `M <= max_output_size`.
class TF_CLASS NonMaxSuppressionV2 {
 public:
...
/// * `Output` out_min
/// * `Output` out_max
class TF_CLASS QuantizedResizeBilinear {
 public:
...
/// * `Output`: 4-D with shape
/// `[batch, new_height, new_width, channels]`.
class TF_CLASS ResizeNearestNeighbor {
 public:
...
class TF_CLASS SampleDistortedBoundingBox {
 public:
...
/// * `Output` bboxes: 3-D with shape `[1, 1, 4]` containing the distorted bounding box.
/// Provide as input to `tf.image.draw_bounding_boxes`.
class TF_CLASS SampleDistortedBoundingBoxV2 {
 public:
...
#endif  // D__TF_TENSORFLOW_TENSORFLOW_CONTRIB_CMAKE_BUILD_TENSORFLOW_CC_OPS_IMAGE_OPS_H_
