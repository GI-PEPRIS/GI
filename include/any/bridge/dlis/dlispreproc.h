 ...
 */
#ifndef __ANYBRIDGE_DLISPREPROC_H__
#define __ANYBRIDGE_DLISPREPROC_H__
...
namespace AnyBridge
{
	...
	*
	**/
	class ANYBRIDGE_CLASS CDlisPreProc
	{
	public:
		struct Slf_CURVE
		{
	...
	public:
		...
		BOOL mENormalize;
		BOOL mEAzimCorrect;
		BOOL mEResCalibration;
		BOOL mSRemoveBadPoint;
		BOOL mSAccCorrect;
		BOOL mSStandOffCorrect;
		BOOL mSAzimCorrect;
		BOOL mSNormalize;
		float mDynamicWL;
		float mDepthShift;
