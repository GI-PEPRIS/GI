 ...
 */
#ifndef ANYWAY_RCF_CORE_RCF_JOB_REDUCE_VALUE__H
#define ANYWAY_RCF_CORE_RCF_JOB_REDUCE_VALUE__H
...
namespace anyway
{
	namespace rcf
	{
		...
		**/
		...
		struct job_reducevalue
		{
			typedef typename traits::job_reducevalue
				<
