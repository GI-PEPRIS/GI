...
struct QuantizedToFloatStruct {
  static const /*constexpr*/ int number_of_bits = sizeof(T) * 8;
  static const /*constexpr*/ int64 number_of_steps = static_cast<int64>(1)
                                           << number_of_bits;
...
struct FloatToQuantizedStruct {
  /*static*/ const /*constexpr*/ int number_of_bits = sizeof(T) * 8;//herman
  /*static*/ const /*constexpr*/ int64 number_of_steps = static_cast<int64>(1)
                                           << number_of_bits;//herman
  /*static constexpr*/ const double range_adjust =
      (number_of_steps / (number_of_steps - 1.0)); //herman
...
inline int16x8_t Divide16x8Pow(const int16x8_t val) {
  static const /*constexpr*/ int16 FIRST_BIT_VAL = 0x0000000000000001;
...
inline int64x2_t Divide64x2Pow(const int64x2_t val) {
  static const /*constexpr*/ int64 FIRST_BIT_VAL = 0x0000000000000001;
