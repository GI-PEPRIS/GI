...
class TF_CLASS DimensionHandle {
 public:
  DimensionHandle() {}
...
struct TF_CLASS DimensionOrConstant {
 public:
...
class TF_CLASS InferenceContext {
 public:
  static const/*constexpr*/ int64 kUnknownDim = -1; //herman
  static const/*constexpr*/ int32 kUnknownRank = -1;
