 ...
 */
#ifndef __ANYSDE_SDE_RASTER_EDITOR_H__
#define __ANYSDE_SDE_RASTER_EDITOR_H__
...
namespace AnySDE
{
	...
	*
	**/
	class ANYSDE_CLASS CAnySdeRasterEditor : public CAnySdeGeometryEditor
	{
	public:
		//
		//
		...
		*
		**/
		CAnySdeRasterEditor(CAnyView &curView, CAnySdeGeometryLayer &layer);
