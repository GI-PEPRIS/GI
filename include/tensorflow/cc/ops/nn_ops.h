...
#ifndef D__TF_TENSORFLOW_TENSORFLOW_CONTRIB_CMAKE_BUILD_TENSORFLOW_CC_OPS_NN_OPS_H_
#define D__TF_TENSORFLOW_TENSORFLOW_CONTRIB_CMAKE_BUILD_TENSORFLOW_CC_OPS_NN_OPS_H_
...
class TF_CLASS Conv2DBackpropFilter {
 public:
...
class TF_CLASS Conv2DBackpropInput {
 public:
...
/// Returns:
/// * `Output`: The output tensor.
class TF_CLASS Conv3DBackpropFilterV2 {
 public:
...
/// Returns:
/// * `Output`: The output tensor.
class TF_CLASS Conv3DBackpropInputV2 {
 public:
...
class TF_CLASS DataFormatDimMap {
 public:
...
class TF_CLASS DataFormatVecPermute {
 public:
...
/// Returns:
/// * `Output`: The output tensor.
class TF_CLASS DepthwiseConv2dNative {
 public:
...
/// `[filter_height, filter_width, in_channels, out_channels]`.  Gradient w.r.t.
/// the `filter` input of the convolution.
class TF_CLASS DepthwiseConv2dNativeBackpropFilter {
 public:
...
/// convolution.
class TF_CLASS DepthwiseConv2dNativeBackpropInput {
 public:
...
class TF_CLASS Dilation2DBackpropFilter {
 public:
...
class TF_CLASS Dilation2DBackpropInput {
 public:
...
class TF_CLASS FractionalAvgPool {
 public:
...
/// * `Output` row_pooling_sequence: row pooling sequence, needed to calculate gradient.
/// * `Output` col_pooling_sequence: column pooling sequence, needed to calculate gradient.
class TF_CLASS FractionalMaxPool {
 public:
...
/// in FusedBatchNorm.
class TF_CLASS FusedBatchNormGrad {
 public:
...
/// * `Output` reserve_space_4: Unused placeholder to match the variance input
/// in FusedBatchNorm.
class TF_CLASS FusedBatchNormGradV2 {
 public:
...
/// * `Output` reserve_space_2: A 1D Tensor for the computed batch variance (inverted variance
/// in the cuDNN case), to be reused in the gradient computation.
class TF_CLASS FusedBatchNormV2 {
 public:
...
/// Returns:
/// * `Output`: The output tensor.
class TF_CLASS FusedResizeAndPadConv2D {
 public:
...
class TF_CLASS MaxPool3DGradGrad {
 public:
...
/// Returns:
/// * `Output`: Gradients of gradients w.r.t. the input to `max_pool`.
class TF_CLASS MaxPoolGradGrad {
 public:
...
/// Returns:
/// * `Output`: Gradients of gradients w.r.t. the input to `max_pool`.
class TF_CLASS MaxPoolGradGradV2 {
 public:
...
class TF_CLASS MaxPoolGradGradWithArgmax {
 public:
...
class TF_CLASS MaxPoolWithArgmax {
 public:
...
class TF_CLASS QuantizedAvgPool {
 public:
...
/// * `Output` result_min
/// * `Output` result_max
class TF_CLASS QuantizedBatchNormWithGlobalNormalization {
 public:
...
class TF_CLASS QuantizedBiasAdd {
 public:
...
/// * `Output` min_output: The float value that the lowest quantized output value represents.
/// * `Output` max_output: The float value that the highest quantized output value represents.
class TF_CLASS QuantizedConv2D {
 public:
...
/// * `Output` min_output: The float value that the lowest quantized output value represents.
/// * `Output` max_output: The float value that the highest quantized output value represents.
class TF_CLASS QuantizedMaxPool {
 public:
...
class TF_CLASS SoftmaxCrossEntropyWithLogits {
 public:
...
/// * `Output` loss: Per example loss (batch_size vector).
/// * `Output` backprop: backpropagated gradients (batch_size x num_classes matrix).
class TF_CLASS SparseSoftmaxCrossEntropyWithLogits {
 public:
...
#endif  // D__TF_TENSORFLOW_TENSORFLOW_CONTRIB_CMAKE_BUILD_TENSORFLOW_CC_OPS_NN_OPS_H_
