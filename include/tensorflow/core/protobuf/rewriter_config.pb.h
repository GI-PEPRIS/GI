...
class RewriterConfig :
 ...
 public:
  ...
  static const /*constexpr*/ Toggle DEFAULT =
    RewriterConfig_Toggle_DEFAULT;
  static const /*constexpr*/ Toggle ON =
    RewriterConfig_Toggle_ON;
  static const /*constexpr*/ Toggle OFF =
    RewriterConfig_Toggle_OFF;
  static const /*constexpr*/ Toggle AGGRESSIVE =
    RewriterConfig_Toggle_AGGRESSIVE;
  static inline bool Toggle_IsValid(int value) {
    return RewriterConfig_Toggle_IsValid(value);
  }
  static const /*constexpr*/ Toggle Toggle_MIN =
    RewriterConfig_Toggle_Toggle_MIN;
  static const /*constexpr*/ Toggle Toggle_MAX =
    RewriterConfig_Toggle_Toggle_MAX;
  static const /*constexpr*/ int Toggle_ARRAYSIZE =
  ...
  static const /*constexpr*/ NumIterationsType DEFAULT_NUM_ITERS =
    RewriterConfig_NumIterationsType_DEFAULT_NUM_ITERS;
  static const /*constexpr*/ NumIterationsType ONE =
    RewriterConfig_NumIterationsType_ONE;
  static const /*constexpr*/ NumIterationsType TWO =
  ...
  static const /*constexpr*/ NumIterationsType NumIterationsType_MIN =
    RewriterConfig_NumIterationsType_NumIterationsType_MIN;
  static const /*constexpr*/ NumIterationsType NumIterationsType_MAX =
    RewriterConfig_NumIterationsType_NumIterationsType_MAX;
  static const /*constexpr*/ int NumIterationsType_ARRAYSIZE =
  ...
  static const /*constexpr*/ MemOptType DEFAULT_MEM_OPT =
    RewriterConfig_MemOptType_DEFAULT_MEM_OPT;
  static const /*constexpr*/ MemOptType NO_MEM_OPT =
    RewriterConfig_MemOptType_NO_MEM_OPT;
  static const /*constexpr*/ MemOptType MANUAL =
    RewriterConfig_MemOptType_MANUAL;
  static const /*constexpr*/ MemOptType SWAPPING_HEURISTICS =
    RewriterConfig_MemOptType_SWAPPING_HEURISTICS;
  static const /*constexpr*/ MemOptType RECOMPUTATION_HEURISTICS =
    RewriterConfig_MemOptType_RECOMPUTATION_HEURISTICS;
  static const /*constexpr*/ MemOptType SCHEDULING_HEURISTICS =
    RewriterConfig_MemOptType_SCHEDULING_HEURISTICS;
  static const /*constexpr*/ MemOptType HEURISTICS =
  ...
  static const /*constexpr*/ MemOptType MemOptType_MIN =
    RewriterConfig_MemOptType_MemOptType_MIN;
  static const /*constexpr*/ MemOptType MemOptType_MAX =
    RewriterConfig_MemOptType_MemOptType_MAX;
  static const /*constexpr*/ int MemOptType_ARRAYSIZE =
