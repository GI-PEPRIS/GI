...
#include "tf_google_shared_main.h" //herman
...
TF_API_NO_C bool CUnescape(absl::string_view source, std::string* dest, std::string* error);
...
TF_API_NO_C std::string CEscape(absl::string_view src);
...
TF_API_NO_C std::string CHexEscape(absl::string_view src);
...
TF_API_NO_C std::string Utf8SafeCEscape(absl::string_view src);
...
// conversion.
TF_API_NO_C std::string Utf8SafeCHexEscape(absl::string_view src);
...
TF_API_NO_C bool Base64Unescape(absl::string_view src, std::string* dest);
...
TF_API_NO_C bool WebSafeBase64Unescape(absl::string_view src, std::string* dest);
...
TF_API_NO_C void Base64Escape(absl::string_view src, std::string* dest);
TF_API_NO_C std::string Base64Escape(absl::string_view src);
...
TF_API_NO_C void WebSafeBase64Escape(absl::string_view src, std::string* dest);
TF_API_NO_C std::string WebSafeBase64Escape(absl::string_view src);

// HexStringToBytes()
//
// Converts an ASCII hex string into bytes, returning binary data of length
// `from.size()/2`.
TF_API_NO_C std::string HexStringToBytes(absl::string_view from);

// BytesToHexString()
//
// Converts binary data into an ASCII text string, returning a string of size
// `2*from.size()`.
TF_API_NO_C std::string BytesToHexString(absl::string_view from);
