 ...
 */
#ifndef __ANYMATH_SHIFT_PARETO_DISTRIBUTION_H__
#define __ANYMATH_SHIFT_PARETO_DISTRIBUTION_H__
...
namespace AnyMath
{
	...
	* TSP
	**/
	class CShiftParetoDistribution : public CAnyDistributionStrategy
	{
	public:
		//
		//
