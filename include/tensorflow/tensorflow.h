...
*/
#ifndef __TENSORFLOW_DEF_H__
#define __TENSORFLOW_DEF_H__
...
#ifdef TENSORFLOW_VS2015_EXPORTS
#define TF_CLASS __declspec(dllexport)
#define TF_API extern "C" __declspec(dllexport)
#define TF_API_NO_C __declspec(dllexport)
#else
#define TF_CLASS __declspec(dllimport)
#define TF_API extern "C" __declspec(dllimport)
#define TF_API_NO_C __declspec(dllimport)

// Resolving symbols
#ifdef _DEBUG
#pragma comment(lib, "tensorflowd.lib")
#pragma message("Automatically linking with tensorflowd.dll")
#else
#pragma comment(lib, "tensorflow.lib")
#pragma message("Automatically linking with tensorflow.dll")
#endif
#endif 
