 ...
 */
#ifndef __ANYBASIN_HYPER_DATA_LINE_SPLITTER_H__
#define __ANYBASIN_HYPER_DATA_LINE_SPLITTER_H__
...
namespace AnyBasin
{
	...
	class HyperLineSplitter : public HyperInputSplitBase 
	{
	public:
		HyperLineSplitter(HyperFileSystem *fs,
			const char *uri,
			unsigned rank,
			unsigned nsplit) {
				this->Init(fs, uri, 1);
